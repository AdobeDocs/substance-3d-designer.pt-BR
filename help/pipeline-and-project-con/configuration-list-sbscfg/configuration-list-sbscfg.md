...
![Ícone de arquivo SBSCFG](configuration-list-sbscfg.resources/sbscfg.png "ícone de arquivo SBSCFG")
...
![Configurações do projeto](configuration-list-sbscfg.resources/config-ui.png "Configurações do projeto")
