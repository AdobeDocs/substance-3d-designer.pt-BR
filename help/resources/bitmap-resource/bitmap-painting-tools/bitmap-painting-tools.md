...
Esta página descreve as ferramentas de pintura disponíveis no painel [Visualização 2D](../../../interface/2d-view/2d-view.md) para bitmaps compatíveis.

![Ferramentas de pintura de bitmap no Visualização 2D](bitmap-painting-tools.resources/2dview-paintingtools-main_1.png "Ferramentas de pintura de bitmap no Visualização 2D"){width="512px"}

## Visão geral

O painel [Visualização 2D](../../../interface/2d-view/2d-view.md) oferece ferramentas básicas de pintura em bitmap que permitem criar ou editar imagens *manualmente* diretamente no aplicativo. Essas ferramentas são particularmente úteis, por exemplo, para pintar rapidamente *máscaras*.

As ferramentas são compatíveis com a entrada da caneta, incluindo a *pressão da caneta*. Para aproveitar as vantagens das exibições com caneta, você pode [desencaixar](../../../interface/customizing-your-wor/customizing-your-workspace.md) o painel [Visualização 2D](../../../interface/2d-view/2d-view.md) e, em seguida, colocá-lo e redimensioná-lo em qualquer configuração que seja mais confortável para pintura.

As edições podem ser *desfeitas individualmente*, e todos os outros recursos do painel Visualização 2D ainda estão *disponíveis* enquanto você edita a imagem, como o painel [Histograma](../../../interface/2d-view/2d-view.md), a [exibição lado a lado](../../../interface/2d-view/2d-view.md) e a [imagem de fundo](../../../interface/2d-view/2d-view.md).

>[!IMPORTANT]
>
> Você pode tinta *somente* em *recursos de [bitmap](../../../resources/bitmap-resource/bitmap-resource.md) de 8 bits* que sejam [novos ou importados](../../../resources/importing-linking-and-new/importing-linking-and-new-resources.md).
...
As ferramentas de pintura serão habilitadas automaticamente no painel [Visualização 2D](../../../interface/2d-view/2d-view.md) quando os seguintes critérios relativos a um bitmap forem atendidos:
...
* O bitmap é exibido no painel [Visualização 2D](../../../interface/2d-view/2d-view.md)
