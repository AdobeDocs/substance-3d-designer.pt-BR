...
![(erro)](parameters-not-working-as-expected.resources/error.svg) <b>Problema</b>
...
![(tick)](parameters-not-working-as-expected.resources/check.svg) <b>Etapas recomendadas</b>
...
| Nó | Parâmetro |
|:---------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------|
| Todos os nós | Modo de divisão em blocos gráficos, Proporção de pixels |
