...
![Substituir material - Ação no visor &#39;Exibição 3D&#39;](../../assets/overrideMaterialActionViewport.png "Substituir material - Ação no visor &#39;Exibição 3D&#39;"){zoomable="yes"}
...
>[!NOTE]
>
> As cópias são criadas na cena em uma pasta ‘<b>material</b>’ (‘Scope’ em USD) na raiz e usam o mesmo identificador que o original, além de um sufixo numérico (por exemplo: ‘rustedMetal\_0’)
...
Se um valor de propriedade de material foi modificado ou uma textura de um gráfico foi aplicada a ele, a propriedade é revertida para seu valor ou textura inicial.
...
![Redefinir material para o estado da cena - Ação no visor “Exibição 3D”](../../assets/resetMaterialToSceneStateActionViewport.png "Redefinir material para o estado da cena - Ação no visor “Exibição 3D”"){zoomable="yes"}
