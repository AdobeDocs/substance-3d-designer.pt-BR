...
![Extrair textura para gráfico - Ação no encaixe Propriedades](extracting-materials-values-and-textures.resources/extractTextureAction.png "Extrair textura para gráfico - Ação no encaixe Propriedades"){zoomable="yes"}
...
![Resultado da extração de textura](extracting-materials-values-and-textures.resources/extractTextureResult.png "Resultado da extração de textura"){zoomable="yes"}
