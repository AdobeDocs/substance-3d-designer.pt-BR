...
| [Vetor](../../../function-graphs/nodes-reference-for-fun/atomic-function-nodes/vector-and-swizzle-nodes/vector-and-swizzle-nodes.md) | Vetor Float2 | Flutuante1 | Flutuante 2 | Converte 2 valores flutuantes em um vetor com 2 coordenadas |
|                                                                                                                                        | Vetor Float3 | Flutuante1 / Flutuante2 | Flutuante 3 | Converte 2 valores flutuantes em um vetor com 3 coordenadas |
|                                                                                                                                        | Vetor Float4 | Flutuante1 / 2 / 3 | Flutuante 4 | Converte 2 valores flutuantes em um vetor com 4 coordenadas |
...
|                                                                                                                                        | Obter Float1 | - | Flutuante1 | Obter uma entrada de valor flutuante de função ou gráfico |
|                                                                                                                                        | Obter Float2 | - | Float2 | Obter uma entrada de valor de função ou gráfico Float2 |
|                                                                                                                                        | Obter Float3 | - | Float3 | Obter uma entrada de valor de função ou gráfico Float3 |
|                                                                                                                                        | Obter Float4 | - | Float4 | Obter uma entrada de valor de função ou gráfico Float4 |
...
|                                                                                                                                        | To Float2 | Integer2 | Float2 | Converte um Inteiro2 em um Float2 |
|                                                                                                                                        | To Float3 | Integer3 | Float3 | Converte um Integer3 em um Float3 |
|                                                                                                                                        | To Float4 | Integer4 | Float4 | Converte um Inteiro4 em um Float4 |
|                                                                                                                                        | Para Integer | Flutuante1 | Inteiro1 | Converte um Float em um Inteiro |
|                                                                                                                                        | To Integer2 | Float2 | Integer2 | Converte um Float2 em um Integer2 |
|                                                                                                                                        | To Integer3 | Float3 | Integer3 | Converte um Float3 em um Integer3 |
|                                                                                                                                        | To Integer4 | Float4 | Integer4 | Converte um Float4 em um Inteiro4 |
| [Operador](../../../function-graphs/nodes-reference-for-fun/atomic-function-nodes/operator-nodes/operator-nodes.md) | Adição | Flutuação de vetor / Inteiro | Tipo de a &amp; b | Adiciona 2 valores do mesmo tipo: a + b |
|                                                                                                                                        | Subtração | Flutuação de vetor / Inteiro | Tipo de a &amp; b | Subtrai 2 valores do mesmo tipo: a - b |
|                                                                                                                                        | Multiplicação | Flutuação de vetor / Inteiro | Tipo de a &amp; b | Multiplica 2 valores do mesmo tipo: a \* b |
|                                                                                                                                        | Multiplicação escalar | Flutuação de vetor | Tipo de um | Multiplica um valor por um valor flutuante: um \* escalar |
|                                                                                                                                        | Divisão | Flutuante1 / Inteiro1 | Tipo de a &amp; b | Divide 2 valores do mesmo tipo: a / b |
|                                                                                                                                        | Negação | Flutuante1 / Inteiro1 | Tipo de um | Retorna o valor de negação: -a |
|                                                                                                                                        | Módulo | Flutuante1 / Inteiro1 | Tipo de um | Retorna o valor do módulo: mod(a, divisor) |
...
| [Comparação](../../../function-graphs/nodes-reference-for-fun/atomic-function-nodes/comparison-nodes/comparison-nodes.md) | Igual | Flutuante1 / Inteiro1 | Boolean | Retorna verdadeiro se a = b |
|                                                                                                                                        | Não igual | Flutuante1 / Inteiro1 | Boolean | Retorna verdadeiro se a != b |
|                                                                                                                                        | Maior | Flutuante1 / Inteiro1 | Boolean | Retorna verdadeiro se a > b |
|                                                                                                                                        | Maior ou igual | Flutuante1 / Inteiro1 | Boolean | Retorna verdadeiro se a >= b |
|                                                                                                                                        | Menor | Flutuante1 / Inteiro1 | Boolean | Retorna verdadeiro se a &lt; b |
|                                                                                                                                        | Menor ou igual | Flutuante1 / Inteiro1 | Boolean | Retorna verdadeiro se a &lt;= b |
| Função | Absoluto | Flutuante1 / Inteiro1 | Flutuante1 | Retorna o valor absoluto de a: abs(a) |
|                                                                                                                                        | Piso | Flutuante1 / Inteiro1 | Flutuante1 | Retorna o valor mais alto menor ou igual a a: floor(a) |
|                                                                                                                                        | Teto | Flutuante1 / Inteiro1 | Flutuante1 | Retorna o menor valor superior ou igual a a: ceil(a) |
|                                                                                                                                        | Cosseno | Flutuante1 / Inteiro1 | Flutuante1 | Retorna o valor de cosseno de a: cos(a) |
|                                                                                                                                        | Seno | Flutuante1 / Inteiro1 | Flutuante1 | Retorna o valor seno de a: sin(a) |
|                                                                                                                                        | Tangente | Flutuante1 / Inteiro1 | Flutuante1 | Retorna o valor tangente de a: tan(a) |
...
|                                                                                                                                        | Raiz quadrada | Flutuante1 / Inteiro1 | Flutuante1 | Retorna o valor raiz quadrada de um |
|                                                                                                                                        | Logarítmico | Flutuante1 / Inteiro1 | Flutuante1 | Retorna o valor logarítmico de a: log(a) |
|                                                                                                                                        | Exponencial | Flutuante1 / Inteiro1 | Flutuante1 | Retorna o valor exponencial de a: exp(a) |
|                                                                                                                                        | Pow 2 | Flutuante1 / Inteiro1 | Flutuante1 | Retorna a potência de 2 valores de um |
|                                                                                                                                        | Interpolação linear | Flutuante1 / Inteiro1 | Flutuante1 | Retorna a interpolação linear entre 2 valores, dependendo de um valor flutuante: (1-x)a + x \* b |
|                                                                                                                                        | Mínimo | Flutuante1 / Inteiro1 | Tipo de a &amp; b | Retorna o valor mínimo entre a e b |
|                                                                                                                                        | Máximo | Flutuante1 / Inteiro1 | Tipo de a &amp; b | Retorna o valor máximo entre a e b |
