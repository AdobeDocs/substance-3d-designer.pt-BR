...
Gire uma forma SDF ao redor de um ou vários eixos de um ponto de giro ajustável, em rotações.<br>Use o <b>Transformar tabela dinâmica</b> auxiliar do <b>Visualizador 3D</b> para visualizar a rotação executada.
...
| <b>Eixo</b> *Flutuante3* | O vetor normalizado que define o eixo em torno do qual a forma SDF é girada.<br>Por exemplo: (0, 1, 0) girará a forma SDF em torno do eixo Y de seu ponto dinâmico local.<br><br>O eixo é visualizado por uma seta no auxiliar <b>Tabela dinâmica de transformação</b> do <b>Visualizador 3D</b>. A cor da seta é mapeada nos componentes XYZ deste vetor.<br><br><i>Padrão: (0, 1, 0)</i> |
