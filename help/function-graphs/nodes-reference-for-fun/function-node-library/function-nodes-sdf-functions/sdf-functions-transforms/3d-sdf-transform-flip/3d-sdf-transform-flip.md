---
title: Virar
description: Designer > Gráficos de composição de Substance > Referência de nós para gráficos de composição de Substance > Biblioteca de nós > Função SDF > Transformar > Virar
...
Aplica uma transformação espelhada à forma SDF de entrada.<br>Basicamente, executa uma escala negativa nos eixos selecionados.
