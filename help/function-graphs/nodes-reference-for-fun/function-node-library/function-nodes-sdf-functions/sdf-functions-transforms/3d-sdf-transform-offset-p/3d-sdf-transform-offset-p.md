...
description: Designer > Gráficos de composição de Substance > Referência de nós para gráficos de composição de Substance > Biblioteca de nós > Função SDF > Transformo > Deslocamento P
...
Desloca o espaço mundial ao longo de um vetor.<br>A posição mundial de saída transformada pode ser conectada à entrada <b>P</b> da maioria das Funções SDF para defini-las neste espaço mundial transformado.<br><br><i>Dica:</i> as transformas P podem ser encadeadas, mas lembre-se de que os resultados dependem da ordem das operações.
