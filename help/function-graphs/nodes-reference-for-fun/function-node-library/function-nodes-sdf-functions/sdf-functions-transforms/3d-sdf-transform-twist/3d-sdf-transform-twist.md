...
description: Designer > Gráficos de composição de Substance > Referência de nós para gráficos de composição de Substance > Biblioteca de nós > Função SDF > Transformar > Torção (inexato)
...
| <b>Ângulo</b> *Flutuante* | Ângulo, em rotações, da rotação aplicada no fim da torção. |
| <b>Iniciar</b> *Flutuante* | A posição mundial no eixo Z onde a torção começa. Todo o volume embaixo não está torcido. |
| <b>Fim</b> *Flutuante* | A posição mundial no eixo Z onde a torção termina. Todo o volume acima é girado uniformemente no ângulo especificado. |
