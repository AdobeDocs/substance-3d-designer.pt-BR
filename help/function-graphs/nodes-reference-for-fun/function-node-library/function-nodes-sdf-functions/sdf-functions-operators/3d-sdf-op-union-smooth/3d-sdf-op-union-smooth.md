---
title: União suave
description: Designer > Gráficos de composição de Substance > Referência de nós para gráficos de composição de Substance > Biblioteca de nós > Função SDF > Operador > União suave
...
![Ícone de união suave](./3d-sdf-op-union-smooth.png "União suave")
...
Retorna os volumes adicionados de duas formas SDF, com suavização ajustável das bordas de sua interseção.
