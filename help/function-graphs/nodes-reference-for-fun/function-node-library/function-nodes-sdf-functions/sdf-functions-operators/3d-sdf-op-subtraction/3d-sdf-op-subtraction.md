---
title: Subtração
description: Designer > Gráficos de composição de Substance > Referência de nós para gráficos de composição de Substance > Biblioteca de nós > Função SDF > Operador > Subtração
...
![Ícone de subtração](./3d-sdf-op-subtraction.png "subtração")
...
Subtrai o volume da forma SDF 1 da forma SDF 2.
