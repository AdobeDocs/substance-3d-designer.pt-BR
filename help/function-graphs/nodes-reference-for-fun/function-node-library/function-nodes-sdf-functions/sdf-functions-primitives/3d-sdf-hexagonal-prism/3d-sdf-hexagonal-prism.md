---
title: Prismo hexagonal
description: Designer > Gráficos de composição de Substance > Referência de nós para gráficos de composição de Substance > Biblioteca de nós > Função SDF > Primitivo > Prisma hexagonal
...
![Ícone de prisma hexagonal](./3d-sdf-hexagonal-prism.png "Prisma hexagonal")
...
Uma Função SDF para um prisma de 6 lados de height ajustável, raio e arredondamento de bordas.
...
|  |  |
| :--- | :--- |
| <b>Height</b> *Flutuante* | O height Z-up do prisma hexagonal de sua base.<br><br><i>Padrão: 1</i> |
