...
Em vez disso, os plug-ins podem usar o <b> novo objeto [UI manager](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/scripting-api-next-172825023.html)</b> e o <b>Qt for Python</b> para criar os elementos de interface de usuário necessários.
...
Os plug-ins podem usar o objeto </b> do <b>[UI manager](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/scripting-api-next-172825023.html) para acessar o gráfico e a seleção ativos no momento.
