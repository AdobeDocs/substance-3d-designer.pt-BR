...
* **Windows 10** versão 1809, consulte [esta página](https://experienceleague.adobe.com/en/docs/substance-3d/bakers/features/gpu-raytracing) para obter mais informações
...
Os usuários do tablet no **Windows** devem aplicar as configurações descritas na página a seguir para obter a experiência mais confiável: [Configurar canetas e tablets](https://experienceleague.adobe.com/en/docs/substance-3d-painter/using/technical-support/configuring-pens-and-tablets).
