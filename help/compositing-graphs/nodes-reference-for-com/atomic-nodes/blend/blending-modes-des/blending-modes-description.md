...
O nó [Combinar](../../../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/blend/blend.md) oferece os seguintes modos de mesclagem:

## Copiar

O modo de mesclagem de *Cópia* apenas colocará o primeiro plano sobre o plano de fundo.

![Modo de mesclagem: copiar](blending-modes-description.resources/image2015-8-20-9-38-0.png "Modo de mesclagem: copiar"){zoomable="yes"}

Para imagens coloridas, o canal alfa é considerado por padrão na opacidade.

Isso pode ser alterado usando o parâmetro &#39;Mesclagem de alfa&#39;.

![Modo de mesclagem: Copiar (2)](blending-modes-description.resources/image2015-8-20-14-15-29.png "Modo de mesclagem: Copiar (2)"){zoomable="yes"}
...
![Modo de mesclagem: Adicionar (Subexposição linear)](blending-modes-description.resources/image2015-8-20-9-38-19.png "Modo de mesclagem: Adicionar (Subexposição linear)"){zoomable="yes"}
...
![Modo de mesclagem: Subtrair](blending-modes-description.resources/image2015-8-20-9-38-35.png "Modo de mesclagem: Subtrair"){zoomable="yes"}
...
![Modo de mesclagem: Multiplicar](blending-modes-description.resources/image2015-8-20-9-38-53.png "Modo de mesclagem: Multiplicar"){zoomable="yes"}
...
![Modo de mesclagem: adicionar sub](blending-modes-description.resources/image2015-8-20-9-39-11.png "Modo de mesclagem: adicionar sub"){zoomable="yes"}

## Max (Clarear)

O modo de mesclagem *Máx* escolherá o valor mais alto entre o plano de fundo e o primeiro plano.

![Modo de mesclagem: Máx. (Clarear)](blending-modes-description.resources/image2015-8-20-9-40-12.png "Modo de mesclagem: Máx. (Clarear)"){zoomable="yes"}

## Min (escurecer)

O modo de mesclagem *Min* escolherá o valor mais baixo entre o plano de fundo e o primeiro plano.

![Modo de mesclagem: Min (Escurecer)](blending-modes-description.resources/image2015-8-20-9-40-31.png "Modo de mesclagem: Min (Escurecer)"){zoomable="yes"}
...
![Modo de mesclagem: alternar](blending-modes-description.resources/image2015-8-20-9-38-0.png "Modo de mesclagem: alternar"){zoomable="yes"}
...
![Modo de mesclagem: Dividir](blending-modes-description.resources/image2015-8-20-9-41-32.png "Modo de mesclagem: Dividir"){zoomable="yes"}
...
![Modo de mesclagem: Sobreposição](blending-modes-description.resources/image2015-8-20-9-41-50.png "Modo de mesclagem: Sobreposição"){zoomable="yes"}
...
![Modo de mesclagem: Tela](blending-modes-description.resources/image2015-8-20-9-42-11.png "Modo de mesclagem: Tela"){zoomable="yes"}

## Luz indireta

O modo de mesclagem Luz indireta cria um resultado sutil mais claro ou mais escuro, dependendo do brilho da cor de primeiro plano.

as cores Combinar com mais de 50% de brilho clareiam os pixels do plano de fundo, e as cores com menos de 50% de brilho escurecem os pixels do plano de fundo.

![Modo de mesclagem: Luz indireta](blending-modes-description.resources/image2015-8-20-9-42-32.png "Modo de mesclagem: Luz indireta"){zoomable="yes"}
