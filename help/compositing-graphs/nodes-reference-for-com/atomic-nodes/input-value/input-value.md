...
breadcrumb-title: ""
description: Use o nó Valor de entrada para criar parâmetros de entrada de valor para gráficos de Substance que podem ser expostos e ajustados pelos usuários.
...
![Nó atômico: valor de entrada](input-value.resources/comp_inputnumeric_1.png "Nó atômico: valor de entrada"){width="20%"}
...
Veja também: [Cor de entrada](../input-color/input-color.md), [Escala de cinza de entrada](../input-grayscale/input-grayscale.md)

</td>
</tr>
</table>

<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-value.resources/input-value-tooltip.gif" alt="Dica de ferramenta de valor de entrada" /></div>

## Parâmetros

Por padrão, uma Cor de entrada ou Escala de cinza retorna preto se nada estiver conectado. Você pode definir um valor padrão diferente ou arrastar um [Recurso de Bitmap](../../../../resources/importing-linking-and-new/importing-linking-and-new-resources.md) existente do [Explorador](../../../../interface/the-explorer-window/the-explorer-window.md) para o nó de Entrada do gráfico, para visualizar esses dados no slot. Isso só funciona para Entradas coloridas e em tons de cinza. O valor padrão é persistente quando usado em outros contextos. O bitmap de visualização é descartado em todos os outros lugares.
...
![Entrada primária no Substance](input-value.resources/node-primary-input.png){width="20%"}
...
>[!IMPORTANT]
>
> O método de herança *Relativo à entrada* para nós de entrada *não tem suporte* em [Ativos do Substance 3D (SBSAR)](../../../publishing-asset-files/publishing-substance-3d-asset-files-sbsar.md). Defina todos os métodos de herança dos nós de entrada como *Relativo ao pai* antes de publicar o pacote.
