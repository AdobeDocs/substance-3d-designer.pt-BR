...
![Nó atômico: valor de entrada](input-value.resources/comp_inputnumeric_1.png "Nó atômico: valor de entrada"){width="100%"}
...
<td style="border: 0; text-align: center" align="center"><img src="input-value.resources/input-value-tooltip.gif" alt="Dica de ferramenta de valor de entrada" /></td>
<td style="border: 0; width: 15%" width="15%"></td>
</tr>
</table>
...
![Entrada primária no Substance](input-value.resources/node-primary-input.png)
