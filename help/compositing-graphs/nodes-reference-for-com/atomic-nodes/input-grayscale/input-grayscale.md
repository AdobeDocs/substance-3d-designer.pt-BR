...
breadcrumb-title: ""
description: Use o nó Tons de cinza de entrada para criar parâmetros de entrada em tons de cinza para gráficos de Substance que podem ser expostos e ajustados pelos usuários.
...
# Tons de cinza de entrada

<table>
<tr style="border: 0;">
<td style="border: 0;" valign="top">

![Nó atômico: escala de cinza de entrada](input-grayscale.resources/comp_inputgrayscale_1.png "Nó atômico: escala de cinza de entrada"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-grayscale.resources/input-grayscale-tooltip.gif" alt="Dica de ferramenta de tons de cinza de entrada" /></div>
...
![Entrada primária no Substance](input-grayscale.resources/node-primary-input.png){width="20%"}
