...
breadcrumb-title: ""
description: Use o nó Cor de entrada para criar parâmetros de entrada de cores para gráficos de Substance que podem ser expostos e ajustados pelos usuários.
...
![Nó atômico: cor de entrada](input-color.resources/comp_inputcolor_1.png "Nó atômico: cor de entrada"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-color.resources/input-color-tooltip.gif" alt="Dica de ferramenta de cor de entrada" /></div>
...
![Entrada primária no Substance](input-color.resources/node-primary-input.png){width="20%"}
