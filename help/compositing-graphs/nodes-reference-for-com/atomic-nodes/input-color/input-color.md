...
![Nó atômico: cor de entrada](input-color.resources/comp_inputcolor_1.png "Nó atômico: cor de entrada")
...
<div data-preserve-html="true" style="text-align: center;"><img src="input-color.resources/input-color-tooltip.gif" alt="Dica de ferramenta de cor de entrada" /></div>
...
![Entrada primária no Substance](input-color.resources/node-primary-input.png)
