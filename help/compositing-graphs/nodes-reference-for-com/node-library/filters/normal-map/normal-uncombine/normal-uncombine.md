...
![Ícone de descombinação normal](normal-uncombine.resources/NormalUncombine.png "Ícone de descombinação normal"){width="200px"}
...
![Normal não combinado: Exemplo 2](normal-uncombine.resources/normal_uncombine_example_4.png "Normal não combinado: Exemplo 2"){zoomable="yes"}
...
![Normal não combinado: Exemplo 4](normal-uncombine.resources/normal_uncombine_example_6.png "Normal não combinado: Exemplo 4"){zoomable="yes"}
...
![Normal não combinado: Exemplo 6](normal-uncombine.resources/normal_uncombine_example_5.png "Normal não combinado: Exemplo 6"){zoomable="yes"}
