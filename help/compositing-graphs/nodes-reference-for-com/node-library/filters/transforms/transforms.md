...
Esta categoria contém um grande número de nós de transformação avançados para entradas de canal único.

Use a <b>lista de navegação à esquerda</b> para procurar todos os nós em Transformações.

Os nós a seguir são exemplos úteis para começar a usar o:

* [Espelhar](../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/transforms/mirror-filter-node/mirror-filter-node.md)
