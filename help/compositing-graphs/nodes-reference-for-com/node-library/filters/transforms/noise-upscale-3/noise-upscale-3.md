...
Utiliza um ruído de entrada processual e o dimensiona para resolução dupla, mantendo os detalhes, mas sem introduzir muitos ladrilhos. Usa uma máscara definida pelo usuário para mesclar ruídos sobre sua escala original.
