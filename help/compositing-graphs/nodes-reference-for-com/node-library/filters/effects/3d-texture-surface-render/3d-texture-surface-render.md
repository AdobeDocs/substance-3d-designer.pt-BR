...
breadcrumb-title: ''
description: Use o nó Renderização de superfície de Textura 3D para renderizar texturas de superfície a partir de dados 3D para criar efeitos de superfície processuais.
