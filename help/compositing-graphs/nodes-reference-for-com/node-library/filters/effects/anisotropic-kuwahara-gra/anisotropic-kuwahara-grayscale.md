...
![Ícone Anisotrópico de Escala de Cinza Kuwahara](anisotropic-kuwahara-gra.resources/anisotropic_kuwahara_grayscale.png "Ícone Anisotrópico de Escala de Cinza Kuwahara"){width="200px"}
...
Veja também: [Cor Kuwahara anisotrópica](../anisotropic-kuwahara/anisotropic-kuwahara.md)
...
![Uma tigela de frutas com o filtro kuwahara foi aplicada com 0 anisotropia.](anisotropic-kuwahara-gra.resources/anisotropic_kuwahara_gray_example_3_before.jpg){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Uma tigela de frutas com o filtro kuwahara foi aplicada com 0 anisotropia.](anisotropic-kuwahara-gra.resources/anisotropic_kuwahara_gray_example_3_after.jpg){zoomable="yes"}
...
|                                                       |                                                                                                                                                                                                                                                                                                                         |
|-------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Entrada</b> <i>Tons de cinza</i><br><code>PRIMÁRIO</code> | A imagem em tons de cinza que deve ser processada. |
...
|                                   |                                                                                                                                                                                                                                      |
|-----------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Saída</b> <i>Tons de cinza</i> | O resultado do desfoque anisotrópico aplicado pelo nó na imagem de entrada. |
