...
* [Ajustes](../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/adjustments/adjustments.md)\
  Expansão dos ajustes de cor, tom e valor.
* [Mesclagem](../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/blending/blending.md)\
  Modos de mesclagem avançados e expandidos.
* [Desfoques](../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/blurs/blurs.md)\
  Desfoques avançados e de alta qualidade.
* [Canais](../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/channels/channels.md)\
...
>[!NOTE]
>
> Um arquivo de projeto que demonstra uma configuração simples para um filtro *personalizado* está disponível na seção [Gráficos de composição de Substance de amostra](../../../../compositing-graphs/sample-compositing-graphs/sample-substance-compositing-graphs.md) desta documentação.
