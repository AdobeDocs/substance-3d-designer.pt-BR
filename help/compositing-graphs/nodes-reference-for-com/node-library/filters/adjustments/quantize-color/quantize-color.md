...
![Ícone Quantizar Cor](quantize-color.resources/quantize-color-01.png "ícone Quantizar Cor"){width="200px"}
...
|  |  |
|:---|:---|
| <b>Entrada</b> <i>Cor</i> PRIMÁRIA | A imagem colorida que deve ser quantizada. |
