...
![Computação do histograma: ícone](histogram-compute.resources/histogram-compute-01.png "Computação do histograma: ícone"){width="200px"}
...
![Computação de histograma: Exemplo 1](histogram-compute.resources/histogram-compute-02.jpg "Computação de histograma: Exemplo 1"){zoomable="yes"}
