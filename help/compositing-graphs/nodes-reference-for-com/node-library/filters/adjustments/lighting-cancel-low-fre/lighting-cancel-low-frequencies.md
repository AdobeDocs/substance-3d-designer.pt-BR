...
breadcrumb-title: ''
description: Use o nó Cancelamento de iluminação de baixas frequências para remover variações de iluminação de baixa frequência do textura para extração de material.
...
Semelhante a Highpass, mas sem diminuir a saturação do resultado final.
