...
breadcrumb-title: ''
description: Acessar nós de processamento de digitalização no Substance 3D Designer para limpar e processar materiais e texturas digitalizados.
...
helpx_learn_topic: ""
helpx_tags: ""
title: Processamento de digitalização
...
Esta categoria destina-se a atender às suas necessidades para processar fotos e digitalizações em materiais PBR completos e ladrilhados. Ele contém uma grande variedade de ferramentas com funções para remover iluminação, cortar bordas e melhorar a divisão em blocos gráficos.

Os seguintes nós são boas introduções:
