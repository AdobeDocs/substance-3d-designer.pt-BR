...
| <b>Deslocamento de Mapas Vetoriais</b> *Flutuante* | Ajusta a quantidade *global* de deslocamento aplicada a cada vértice usando os valores *amostrados* da entrada <b>Mapa Vetorial</b>.    Esta *pilha* de deslocamento com os parâmetros <b>Posição aleatória</b> e <b>Deslocamento de Quincux</b>. |
