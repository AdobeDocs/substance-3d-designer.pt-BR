...
Gera um padrão angular, semelhante a um vinco de tecido. Semelhante a [Aumentar ruído](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/texture-generators/noises/creased/creased.md).
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="crystal-2.resources/crystal-2-1.png" class="modal-image" alt="Crystal 2 - Exemplo 1" />
        </td>
