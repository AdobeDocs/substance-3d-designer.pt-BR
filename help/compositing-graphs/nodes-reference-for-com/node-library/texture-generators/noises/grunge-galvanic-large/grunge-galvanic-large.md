...
O nó **Galvânico de Desgaste Grande** gera um mapa de desgaste semelhante ao padrão de aço galvanizado.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-galvanic-large.resources/grungegalvaniclarge-variant.jpg" class="modal-image" alt="Desgaste Galvânico Grande - Exemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-galvanic-large.resources/grungegalvaniclarge-variant2.jpg" class="modal-image" alt="Desgaste Galvânico Grande - Exemplo 2" />
        </td>
