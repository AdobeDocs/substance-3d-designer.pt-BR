...
![Ruído gaussiano - Ícone](gaussian-noise.resources/gaussian-noise-01.png "Ruído gaussiano - Ícone"){width="200px"}
...
![Ruído gaussiano - Exemplo 1](gaussian-noise.resources/gaussian-noise-02.png "Ruído gaussiano - Exemplo 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Ruído gaussiano - Exemplo 2](gaussian-noise.resources/gaussian-noise-03.gif "Ruído gaussiano - Exemplo 2"){zoomable="yes"}
...
![Ruído gaussiano - Exemplo 3](gaussian-noise.resources/gaussian-noise-04.gif "Ruído gaussiano - Exemplo 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Ruído gaussiano - Exemplo 4](gaussian-noise.resources/gaussian-noise-05.gif "Ruído gaussiano - Exemplo 4"){zoomable="yes"}
