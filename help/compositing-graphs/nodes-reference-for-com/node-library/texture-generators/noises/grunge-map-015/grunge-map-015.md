...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-015.resources/grungemap-015-ex.gif" class="modal-image" alt="Mapa do desgaste 015 - Exemplo 1" />
        </td>
