---
helpx_url: "https://helpx.adobe.com/br/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/grunge-map-007.html"
breadcrumb-title: ""
description: Use o nó Mapa do Desgaste 007 para criar texturas de desgaste processuais para adicionar variação de superfície e efeitos de desgaste.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-007.resources/grungemap-007-ex.gif" class="modal-image" alt="Mapa do desgaste 007 - Exemplo 1" />
        </td>
