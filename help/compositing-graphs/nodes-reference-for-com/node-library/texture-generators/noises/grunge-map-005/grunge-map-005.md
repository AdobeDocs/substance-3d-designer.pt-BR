---
helpx_url: "https://helpx.adobe.com/br/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/grunge-map-005.html"
breadcrumb-title: ""
description: Use o nó Mapa do Desgaste 005 para criar texturas de desgaste processuais para adicionar detalhes da superfície e variação aos materiais.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-005.resources/grungemap-005-ex.gif" class="modal-image" alt="Mapa do desgaste 005 - Exemplo 1" />
        </td>
