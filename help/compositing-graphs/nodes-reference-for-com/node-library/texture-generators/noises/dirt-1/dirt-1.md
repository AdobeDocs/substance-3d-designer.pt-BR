---
helpx_url: "https://helpx.adobe.com/br/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/dirt-1.html"
breadcrumb-title: ''
description: Use o nó Dirt 1 para gerar padrões básicos de dirt para criar detalhes de superfície envelhecidos e efeitos de acúmulo.
...
![Dirt 1 - Ícone](dirt-1.resources/dirt_1.png "Dirt 1 - Ícone"){width="200px"}
...
![Dirt 1 - Exemplo 1](dirt-1.resources/dirt_1_1.png "Dirt 1 - Exemplo 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 1 - Exemplo 2](dirt-1.resources/noise_dirt_1_v2_speed0.6_aniso0.gif "Dirt 1 - Exemplo 2"){zoomable="yes"}
...
![Dirt 1 - Exemplo 3](dirt-1.resources/noise_dirt_1_v2_speed0.6_aniso1.gif "Dirt 1 - Exemplo 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 1 - Exemplo 4](dirt-1.resources/noise_dirt_1_v2_speed0.3_aniso0.6.gif "Dirt 1 - Exemplo 4"){zoomable="yes"}
