---
helpx_url: "https://helpx.adobe.com/br/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/dirt-5.html"
breadcrumb-title: ''
description: Use o nó Dirt 5 para gerar padrões de dirt avançados para criar detalhes de superfície envelhecidos e envelhecidos.
...
![Dirt 5 - Ícone](dirt-5.resources/dirt_5.png "Dirt 5 - Ícone"){width="200px"}
...
![Dirt 5 - Exemplo 1](dirt-5.resources/dirt_5_1.png "Dirt 5 - Exemplo 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 5 - Exemplo 2](dirt-5.resources/noise_dirt_5_v2_speed0.6_aniso0.gif "Dirt 5 - Exemplo 2"){zoomable="yes"}
...
![Dirt 5 - Exemplo 3](dirt-5.resources/noise_dirt_5_v2_speed0.6_aniso1.gif "Dirt 5 - Exemplo 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 5 - Exemplo 4](dirt-5.resources/noise_dirt_5_v2_speed0.3_aniso0.6.gif "Dirt 5 - Exemplo 4"){zoomable="yes"}
