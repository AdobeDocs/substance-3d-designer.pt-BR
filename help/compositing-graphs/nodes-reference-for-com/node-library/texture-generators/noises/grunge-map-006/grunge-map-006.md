...
breadcrumb-title: ""
description: Use o nó Mapa do Desgaste 006 para gerar padrões de desgaste processuais para criar superfícies de materiais envelhecidos e envelhecidos.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-006.resources/grungemap-006-ex.gif" class="modal-image" alt="Mapa do desgaste 006 - Exemplo 1" />
        </td>
