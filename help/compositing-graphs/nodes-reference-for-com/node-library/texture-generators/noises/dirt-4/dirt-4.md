---
helpx_url: "https://helpx.adobe.com/br/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/dirt-4.html"
breadcrumb-title: ''
description: Use o nó Dirt 4 para gerar padrões de dirt intermediários a fim de criar detalhes de superfície envelhecidos e efeitos de acúmulo.
...
![Dirt 4 - Ícone](dirt-4.resources/dirt_4.png "Dirt 4 - Ícone"){width="200px"}
...
![Dirt 4 - Exemplo 1](dirt-4.resources/dirt_4_1.png "Dirt 4 - Exemplo 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 4 - Exemplo 2](dirt-4.resources/noise_dirt_4_v2_speed0.6_aniso0.gif "Dirt 4 - Exemplo 2"){zoomable="yes"}
...
![Dirt 4 - Exemplo 3](dirt-4.resources/noise_dirt_4_v2_speed0.6_aniso1.gif "Dirt 4 - Exemplo 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 4 - Exemplo 4](dirt-4.resources/noise_dirt_4_v2_speed0.3_aniso0.6.gif "Dirt 4 - Exemplo 4"){zoomable="yes"}
