...
O nó **Galvanic Small** do Desgaste gera um mapa de desgaste semelhante ao padrão de aço densamente galvanizado.
...
| <b>Avançado</b> |  |
| <b>Nitidez</b> <i>Precisão decimal</i> | Ajusta a nitidez das formas galvanizadas. |
| <b>Dirt</b> <i>Precisão decimal</i> | Ajusta a opacidade da sobreposição da dirt. |
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-galvanic-small.resources/grungegalvanicsmall-variant2.jpg" class="modal-image" alt="Desgaste Galvânico Pequeno - Exemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-galvanic-small.resources/grungegalvanicsmall-variant.jpg" class="modal-image" alt="Desgaste Galvânico Pequeno - Exemplo 2" />
        </td>
