...
* Avançado
  * **Quantidade de Scratches** *Flutuação* Ajusta a quantidade de arranhões finos na superfície.
  * **Intensidade da nitidez** *Flutuante* Ajusta a intensidade do efeito de nitidez global.
  * **Desvio do valor de arranhão** *Flutuante* Ajusta o equilíbrio dos valores de luminância atribuídos a arranhões individuais.
