...
O nó **Scratches de Desgaste Sujo** gera um mapa de desgaste semelhante a uma superfície suja bem arranhada.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-scratches-dirty.resources/grungescratchesdirty-variant2.jpg" class="modal-image" alt="Scratches de desgaste sujo - Exemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-scratches-dirty.resources/grungescratchesdirty-variant.jpg" class="modal-image" alt="Scratches desgaste sujo - Exemplo 2" />
        </td>
