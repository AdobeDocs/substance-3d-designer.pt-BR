...
![Pontos PB 2 - Ícone](bnw-spots-2.resources/bnw_spots_2.png "Pontos PB 2 - Ícone"){width="200px"}
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/bnw_spots_2_1.png" class="modal-image" alt="Pontos P/B 2 - Exemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.6_aniso0.gif" class="modal-image" alt="Pontos P/ B 2 - Exemplo 2" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.6_aniso1.gif" class="modal-image" alt="Pontos de largura de banda 2 - Exemplo 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="Pontos de largura de banda 2 - Exemplo 4" />
        </td>
