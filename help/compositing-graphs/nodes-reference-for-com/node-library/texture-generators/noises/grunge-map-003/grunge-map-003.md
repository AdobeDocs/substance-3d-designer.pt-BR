...
breadcrumb-title: ""
description: Use o nó Mapa do Desgaste 003 para criar texturas de desgaste processuais para adicionar variação de superfície e efeitos de envelhecimento.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-003.resources/grungemap-003-ex.gif" class="modal-image" alt="Mapa do desgaste 003 - Exemplo 1" />
        </td>
