...
|  |  |
|:---|:---|
| <b>Curvatura</b> <i>Entrada em tons de cinza</i> | Mapa planejado ou gerado para ajudar com o posicionamento das ferrugens. |
| <b>Oclusão de ambiente</b> <i>Entrada em tons de cinza</i> | Mapa planejado ou gerado para ajudar com o posicionamento das ferrugens. |
| <b>Posição</b> <i>Entrada em tons de cinza</i> | Mapa cozido ou gerado para direções de gotejamento. |
