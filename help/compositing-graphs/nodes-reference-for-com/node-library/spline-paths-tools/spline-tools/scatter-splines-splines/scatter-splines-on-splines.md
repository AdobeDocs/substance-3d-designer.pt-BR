...
|  |  |
| --- | --- |
| <b>Iniciar Modo de Height</b> *Inteiro* | O método de calcular o height inicial dos splines dispersos.   Manual Defina o mesmo valor absoluto para todas as splines dispersas.   Da spline pai (+ spline personalizada) Use o height da spline pai e, em seguida, adicione o height da spline personalizada usando o mult de height de início de spline personalizado <b>.Parâmetro </b>.   Na spline personalizada, use o height da spline personalizada como está.   *Observação:* defina <b>Tipo de Spline</b> como &#39;Spline Personalizada&#39; e conecte as entradas de <b>Spline Personalizada</b> para usar o height de splines personalizadas. |
