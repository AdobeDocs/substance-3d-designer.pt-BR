...
| <b>Espaçamento da spline</b> *Precisão decimal* | A distância mínima ao longo das linhas divisórias principais pela qual as linhas divisórias devem ser espaçadas, ainda aterrando a primeira e última linha divisória no início e no fim de cada linha divisória principal, respectivamente. |
...
| <b>Iniciar</b> *Precisão decimal* | Desloca o ponto a partir do início das splines principais onde a dispersão começa. O valor é o comprimento normalizado de cada spline pai. |
...
| <b>Iniciar Height</b> *Precisão decimal* | Define um valor absoluto para o height inicial da spline dispersa. |
...
| <b>Mult de Height de Fim de Spline Personalizado.</b> *Precisão decimal* | Controla a contribuição do próprio height final da spline personalizada para o height final das splines dispersas, onde 1 significa que o height completo da spline personalizada é usado.<br>O height da spline personalizada é usado de forma diferente, de acordo com o <b>Modo de Height Final</b> selecionado:<br>- <i>Da spline pai (+ spline personalizada):</i> O height é adicionado à spline pai<br>- <i>Da spline personalizada:</i> O height é usado diretamente |
| <b>Deslocamento do Height Final</b> *Precisão decimal* | Aplica um deslocamento absoluto ao height final da spline dispersa. |
| <b>Encerrar Height</b> *Precisão decimal* | Define um valor absoluto para o height final da spline dispersa. |
| <b>Thickness</b> |  |
...
| <b>Iniciar Multiplicador de Thickness</b> *Precisão decimal* | Dimensiona o thickness inicial dos splines dispersos, onde 1 é o thickness completo. |
| <b>Iniciar Deslocamento de Thickness</b> *Precisão decimal* | Aplica um deslocamento absoluto ao thickness inicial da spline dispersa. |
