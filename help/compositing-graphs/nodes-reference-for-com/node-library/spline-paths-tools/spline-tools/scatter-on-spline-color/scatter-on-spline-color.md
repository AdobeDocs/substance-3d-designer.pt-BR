...
breadcrumb-title: ''
description: Use o nó Dispersão na cor de spline para distribuir elementos de cor ao longo dos caminhos de spline para padrões processuais.
...
| <b>Multiplicador do Índice de Forma</b> <i>Precisão decimal</i> | A intensidade com que o alfa de cada padrão é multiplicado em relação ao índice normalizado.<br>Observação: a cor de saída é o resultado ponderado de todos os multiplicadores de cores. |
| <b>Multiplicador de Height de spline</b> <i>Precisão decimal</i> | A intensidade com que o alfa de cada padrão é multiplicado em relação ao height da spline em seu local.<br>Observação: a cor de saída é o resultado ponderado de todos os multiplicadores de cores. |
| <b>Luminância aleatória</b> <i>Precisão decimal</i> | Aplica um multiplicador aleatório até o valor especificado para diminuir o alfa dos padrões.<br>Observação: a cor de saída é o resultado ponderado de todos os multiplicadores de cores. |
