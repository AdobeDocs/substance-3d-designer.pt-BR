...
![Ícone de nó](uv-mapper-color.resources/uv-mapper-color-icon.png "Ícone de nó")
...
![Nó no gráfico](uv-mapper-color.resources/UVMapperColor-Graph.jpg "Nó no gráfico")
