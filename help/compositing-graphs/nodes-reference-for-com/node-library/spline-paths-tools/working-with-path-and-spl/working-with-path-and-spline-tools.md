...
![Cúbico de spline em Visualização 2D](working-with-path-and-spline-tools.resources/SplineCubic-Demo.gif "Cúbico de spline em Visualização 2D")
...
O [Transformo 2D de spline](../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/spline-2d-transform/spline-2d-transform.md) e a [Distorção de spline](../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/spline-warp/spline-warp.md) permitem editar a forma das splines.
