...
A caixa de diálogo Exportar PSD só pode ser aberta por um método. Na [exibição de gráfico](../../interface/the-graph-view/the-graph-view.md) do gráfico que você deseja exportar para o PSD, clique no botão ![](exporting-psd-files.resources/exporting-psd-files-01.png) <b>Ferramentas</b> e selecione <b>Exportar PSD</b>. A interface torna-se visível na <b>Exibição de gráfico</b>.

<table>
<tr style="border: 0;">
<td style="border: 0;" valign="top">

![interface de usuário do PSD Exporter](exporting-psd-files.resources/exporting-psd-files-02.png "interface de usuário do PSD Exporter")
