...
Todos os Parâmetros expostos são listados na guia Parâmetros de entrada. As propriedades a seguir estão disponíveis para os casos mais comuns, como Precisão decimal e Inteiros com tipo de Editor padrão.

1. <b>Identificador</b>: identificador exclusivo para este parâmetro. Não pode conter espaços ou caracteres especiais.
1. <b>Rótulo</b>: rótulo somente de interface do usuário. Se nenhuma Etiqueta for definida, o identificador será mostrado na interface. Pode conter espaços e caracteres especiais
