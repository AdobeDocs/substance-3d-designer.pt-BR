...
As amostras devem ser usadas como um modelo de gráfico, o que significa que são acessadas <b>criando um novo gráfico de Substance</b>.
O novo gráfico é uma <b>cópia totalmente editável</b> da amostra, que você pode editar, separar e expandir como quiser.
Você pode criar quantos gráficos novos desejar a partir das amostras.

Todas as amostras são baseadas no modelo de material **OpenPBR**, um novo padrão da indústria com suporte crescente.

Ao criar um novo gráfico de Substance, você encontrará as amostras na [caixa de diálogo Novo gráfico de Substance](../../../compositing-graphs/creating-compositing-gra/creating-a-substance-compositing-graph.md):
...
Na caixa de diálogo, passe o ícone de informações de um item de amostra para obter mais informações sobre os conceitos e técnicas
exploradas na amostra.
...
Clique duas vezes em qualquer item para criar um gráfico a partir dessa amostra. Você também pode selecionar a amostra e clicar em
o botão <b>Criar</b>.
