...
### ![(erro)](../../assets/error.svg) A função do parâmetro *[x]* possui alguns avisos
...
![Aviso de correção de &#39;A função de parâmetro tem alguns avisos&#39;](../../assets/warnings-comp-param-function.gif "Aviso de correção de &#39;A função de parâmetro tem alguns avisos&#39;")
...
![Corrigir o aviso &#39;Dados referenciados têm alguns avisos&#39;](../../assets/warnings-comp-referenced-data.gif "Corrigir o aviso &#39;Dados referenciados têm alguns avisos&#39;")
...
### ![(erro)](../../assets/error.svg) O nó de texto usa uma fonte inválida
