...
* **Operadores** combinam ou replicam formas de maneira direta ou complexa, dependendo do nó: de operadores booleanos simples a morfos, conchas e simetrias, eles expandem drasticamente as possibilidades de que tipo de forma 3D pode ser obtida
* As **Transformações** permitem ajustar a posição, a rotação e o tamanho das formas, conforme você espera e além, com dobras, torção e alongamento.
...
Ao criar Funções SDF 3D, será necessário visualizar as formas resultantes no espaço 3D. O [nó de visualizador 3D](../../compositing-graphs/nodes-reference-for-com/node-library/filters/effects/3d-viewer/3d-viewer.md) renderiza o SDF 3D ou as funções de interseção como uma cena 3D com controles ajustáveis de câmera, luz ambiente personalizada e suporte para renderização de materiais básicos. (Cor, rugosidade e metalidade)
...
O sombreador de OpenPBR agora é o padrão para a Visualização 3D e oferece suporte nativo a gráficos de versões anteriores, combinando os usos do PBR herdado com os do OpenPBR.
...
<table style="border: none;">
    <tr style="vertical-align: top; border: 0">
        <td style="border: 0">
            Também é mais fácil manter os fluxos de trabalho que envolvem sombreadores específicos em sincronia, com um novo atributo <a href="../../compositing-graphs/graph-parameters/graph-parameters.md#attributes">'Modelo de material'</a> para gráficos de Substance que garante que os gráficos visualizados na Visualização 3D usem o sombreador apropriado para o modelo de material do gráfico.
        </td>
...
## Controles de deslocamento na Visualização 3D

Agora é mais rápido e fácil ajustar o deslocamento e o mosaico na Visualização 3D, com acesso direto a um [novo pop-up de Deslocamento](../../interface/3d-view/displacement/displacement.md) disponível na barra de ferramentas Exibição 3D.
...
<img style="display: block; margin: auto" src="../../interface/3d-view/displacement/displacement.resources/3d-view-displacement-popup-mograph.gif" alt="Pop-up de deslocamento na Visualização 3D" />
...
<table style="border: none; margin-top: 32px; margin-bottom: 32px">
    <tr style="vertical-align: top; border: 0">
        ...
        <td style="width: 60%; border: 0">
            <img src="../../compositing-graphs/nodes-reference-for-com/node-library/values/constant.resources/constants-float-01.png" alt="Nó &apos;Float&apos; constante" />
        </td>
    </tr>
</table>
