...
* **Abrir o menu ao clicar e arrastar um link de um nó**\
  Ao clicar, arrastar a conexão de um nó e soltar o mouse, o menu Criação de nós é aberto. O nó criado será então conectado ao link. Os nós disponíveis na lista dependerão da conexão de entrada. ![](../../../assets/click-drag-insert-node.gif)
