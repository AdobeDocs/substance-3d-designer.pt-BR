---
helpx_url: "https://helpx.adobe.com/br/substance-3d-designer/release-notes/old-versions/version-2019-2-9-2.html"
breadcrumb-title: ''
...
* **Revestimento**\
  O revestimento permite definir uma segunda camada de material acima do material de base. Pode ser usado para simular tintas de carros ou filmes em superfícies metálicas.\
  ...
  * **Aspereza do revestimento**: aspereza para a camada de revestimento.
  ...
  Nota: o revestimento requer o novo sombreador “physically\_metallic\_roughness\_coated”.
...
* **Dispersão da Subsuperfície**\
  ...
  * **dispersão**: controla a intensidade da difusão de luz dentro do material.
  ...
  Nota: Subsuperfície requer o novo sombreador “physically\_metallic\_roughness\_sss” . A cor de dispersão pode ser controlada nos parâmetros de sombreador.

  ![](version-2019-2-9-2.resources/sub-surface-scattering-0.jpg){width="400px"}

>[!NOTE]
>
> Todos esses novos recursos de renderização são possíveis graças a um retrabalho do sistema de sombreador de Substance Designer. Nosso formato **GLSLFX** agora dá suporte à definição de “**Técnicas**” que permite várias passagens de renderização. Para alguns exemplos, confira nossos sombreadores padrão disponíveis em: **Substance Designer/resources/view3d/shaders**
...
Com esta nova versão, introduzimos vários novos filtros dedicados à manipulação de mapas de ambiente de HDR.

* **HDR Mesclar**:Bring várias fotos LDR (Low Dynamic Range, Intervalo dinâmico baixo) para criar uma imagem HDR.
* O nó **Nadir patch**:This permite clonar/corrigir a parte terrestre de um HDRI, levando em consideração a deformação esférica.
* **Nadir extract**: este nó pode extrair uma textura de um HDRI. Pode ser usado para mapear uma textura terrestre em uma cena 3D.
...
* **Luz de plano**: gere uma luz retangular como se ela fosse uma forma 3D. Você pode alterar sua posição na Visualização 2D, aplicar uma textura e definir a cor usando um valor de temperatura ou RGB.
...
* [Conteúdo] Novo filtro ‘Visualização de HDR’
...
* [Padeiros] A lista de seleção “Do recurso” não é filtrada corretamente
* [Padarias] Falha ao encadear “Mapa de cores da malha” e “Mapa normal da malha” padarias no Embree
