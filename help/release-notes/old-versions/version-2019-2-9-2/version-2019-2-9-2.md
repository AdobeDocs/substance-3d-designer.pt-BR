...
* **Luz de linha**: crie uma luz em forma de linha e altere sua posição no Visualização 2D. Ele tem opções semelhantes à luz do plano, exceto que é projetado para formas longas finas, como luzes de néon.
