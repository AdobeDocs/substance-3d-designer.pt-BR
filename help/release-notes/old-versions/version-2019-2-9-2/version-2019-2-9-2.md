...
* **Abrir o menu ao clicar e arrastar um link de um nó**\
  Ao clicar, arrastar a conexão de um nó e soltar o mouse, o menu Criação de nós é aberto. O nó criado será então conectado ao link. Os nós disponíveis na lista dependerão da conexão de entrada. ![](version-2019-2-9-2.resources/version-2019-2-9-2-05.gif)
...
* **Luz da esfera**: gere uma luz em forma de esfera e altere sua posição usando o Visualização 2D. Você também pode aplicar uma textura esférica para criar planetas distantes.
