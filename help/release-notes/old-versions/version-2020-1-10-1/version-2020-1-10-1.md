...
* Desenvolva processuais shaders e texturas em paralelo.
* Crie sombreadores avançados para Substance Painter com recursos como mapas de detalhes e máscaras processuais alteráveis no tempo de execução.
* Combine os recursos de sombreador de um mecanismo de jogo ou pipeline VFX no visor Substance Designer e Substance Painter.
...
Além do OpenColorIO, agora é possível usar o Adobe Color Engine (ACE) para suportar perfis ICC no gerenciamento de cores. Isso significa que agora é possível importar e exportar imagens calibradas para que correspondam a outros softwares, como o Photoshop e o Illustrator.
...
* **ACE para Gerenciamento de Cores Herdadas**\
  O transformo de saída mapeado em tons de ACE agora está disponível com o modo de gerenciamento de cores herdado.
