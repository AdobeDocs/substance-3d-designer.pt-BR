...
O Substance Engine está agora na versão 7 e com ele traz o novo conceito de “Valores” dentro do gráfico de composição. Os valores são números e não texturas e, como tal, podem ser usados para executar várias computações que podem ser compartilhadas entre nós através dos gráficos de função e gráficos de composição. O nó Processador de valor pode ler uma imagem de entrada e calcular um único valor de saída.

O nó Processador de Valores não está sozinho, para poder transmitir informações de trânsito pelo gráfico, algumas alterações e adições foram feitas:
...
### Suporte da Optix em padarias

![](../../../assets/baking-speed.jpg)

A última atualização do Substance Designer introduziu o DXR que permite executar Rastreamento de raios do GPU em hardware compatível com RTX. Agora adicionamos suporte para o [Optix](https://developer.nvidia.com/optix), que permite o raytrace em outras GPUs da Nvidia, mesmo em Linux. Você pode esperar uma cozedura pelo menos **5 vezes mais rápida** ao usar o Optix do que com o rastreamento de raios normal da CPU.

Aqui está a lista de padeiros afetados por essa mudança :
