...
Duas novas otimizações foram feitas nesta nova versão que reduzem o tempo entre iterações:
...
* **Dilatação e geração de difusão de Padeiros aprimoradas**\
  A geração de dilatação e difusão de texturas assadas agora é até quatro vezes mais rápida do que nas versões anteriores. Isso reduz o tempo de espera entre os bolos.
