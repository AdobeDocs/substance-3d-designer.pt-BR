...
Para exibir ou ocultar um item de interface específico, clique em seu nome no menu *Janelas*. Os itens exibidos têm uma marca de seleção ![](customizing-your-workspace.resources/customizing-your-workspace-01.png).
...
![Menu do Windows](customizing-your-workspace.resources/customizing-your-workspace-02.png "Menu do Windows")
...
![Redimensionando docas](customizing-your-workspace.resources/customizing-your-workspace-03.gif "Redimensionando docas")
...
![Movendo docas](customizing-your-workspace.resources/customizing-your-workspace-04.gif "Movendo docas")
...
![Docas de tabulação](customizing-your-workspace.resources/customizing-your-workspace-05.gif "Docas de tabulação")
...
* Movendo o encaixe usando sua *barra de título* e colocando-o *fora da janela principal* ou em uma área da janela principal que *não é um encaixe*. Você pode reencaixar este encaixe movendo-o em outro encaixe *na janela principal* ou clicando no botão <b>![](customizing-your-workspace.resources/customizing-your-workspace-06.png) Reencaixar</b>;
* Clique no botão <b>![](customizing-your-workspace.resources/customizing-your-workspace-07.png) Desencaixar</b>. Um encaixe desencaixado com este método pode *apenas* ser reencaixado clicando no botão <b>![](customizing-your-workspace.resources/customizing-your-workspace-06.png) Reencaixar</b>.

![Desencaixando](customizing-your-workspace.resources/customizing-your-workspace-08.gif "Desencaixando")
...
* Clique no botão <b>![](customizing-your-workspace.resources/customizing-your-workspace-09.png) Maximizar</b>
...
* Colocando o *cursor sobre o encaixe* e pressionando o pressionamento da tecla <b>Shift+Espaço</b>
* Clicando no botão <b>![](customizing-your-workspace.resources/customizing-your-workspace-10.png) Minimizar</b>
...
![Maximizando encaixes](customizing-your-workspace.resources/customizing-your-workspace-11.gif "Maximizando encaixes")
...
Para fixar um encaixe, clique no botão ![](customizing-your-workspace.resources/customizing-your-workspace-12.png) <b>Fixar</b>. Depois, você pode *desafixar* usando o botão ![](customizing-your-workspace.resources/customizing-your-workspace-13.png) <b>Desafixar</b> para torná-lo mais uma vez *disponível* para hospedar qualquer conteúdo novo.
...
![Fixando docas](customizing-your-workspace.resources/customizing-your-workspace-14.gif "Fixando docas")

## Fechando docas

Qualquer encaixe pode ser fechado clicando no botão ![](customizing-your-workspace.resources/customizing-your-workspace-15.png) <b>Fechar</b>.
...
![Redefinir layout](customizing-your-workspace.resources/customizing-your-workspace-16.gif "Redefinir layout")
