...
![Barra de ferramentas do localizador de nós](node-finder.resources/node-finder-toolbar.png "Barra de ferramentas do localizador de nós"){zoomable="yes"}
...
Na barra de ferramentas Exibição de Gráfico, clique no <b>botão Localizador de Nó ![](node-finder.resources/graph-node-finder.png)</b> para exibir a barra de ferramentas Localizador de Nó. Quando exibida, a barra de ferramentas só é fechada clicando nesse botão.
...
![Localizador de nós: gráficos de percurso durante a pesquisa](node-finder.resources/node-finder-traversal.gif "Localizador de nós: gráficos de percurso durante a pesquisa"){zoomable="yes"}

### Consulta de pesquisa

![Campo de consulta do localizador de nós](node-finder.resources/node-finder-query-field.png "Campo de consulta do localizador de nós"){zoomable="yes"}
...
![Tipo de nó](node-finder.resources/node-finder-node-types.png "Tipo de nó"){zoomable="yes"}
...
![Tipos de nós (composição)](node-finder.resources/node-finder-types-compositing.png "Tipos de nós (composição)"){zoomable="yes"}



*Tipos de nó para composição de gráficos*

![Tipos de nós (função)](node-finder.resources/node-finder-types-function.png "Tipos de nós (função)"){zoomable="yes"}
...
![Localizador de nós: pesquisando por tipo de &#39;Níveis&#39; (composição)](node-finder.resources/node-finder-compositing-levels.png "Localizador de nós: pesquisando por tipo de &#39;Níveis&#39; (composição)"){zoomable="yes"}
...
![Localizador de nós: pesquisando por tipo de &#39;Instância&#39; (composição)](node-finder.resources/node-finder-compositing-instances.png "Localizador de nós: pesquisando por tipo de &#39;Instância&#39; (composição)"){zoomable="yes"}



*Procurando o tipo de nó &#39;Instance&#39; em um Substance gráfico*

![Localizador de nós: pesquisando por tipo (função) &#39;Instância&#39;](node-finder.resources/node-finder-functions-instances.png "Localizador de nós: pesquisando por tipo (função) &#39;Instância&#39;"){zoomable="yes"}
...
O botão <b>Opções de pesquisa ![](node-finder.resources/node-finder-search-options.png)</b> abre uma lista de configurações usadas para pesquisa que podem ser ativadas e desativadas.
...
![Opções de pesquisa do localizador de nós](node-finder.resources/node-finder-search-options-open.png "Opções de pesquisa do localizador de nós"){zoomable="yes"}
...
![Localizador de nós: pesquisando por identificador de gráfico](node-finder.resources/node-finder-functions-identifier.png "Localizador de nós: pesquisando por identificador de gráfico"){zoomable="yes"}
...
![Explorador: conteúdo do pacote](node-finder.resources/explorer-package-simple.png "Explorador: conteúdo do pacote"){zoomable="yes"}
...
![Identificador de gráfico na dica de ferramenta do nó de instância](node-finder.resources/node-finder-compositing-identifier.png "Identificador de gráfico na dica de ferramenta do nó de instância"){zoomable="yes"}
...
![Localizador de nós: Variáveis de nós](node-finder.resources/node-finder-compositing-variable.png "Localizador de nós: Variáveis de nós"){zoomable="yes"}
...
![Sugestões de consulta do localizador de nós](node-finder.resources/node-finder-available-query-suggestions.png "Sugestões de consulta do localizador de nós"){zoomable="yes"}
...
![Localizador de nós: parâmetros expostos](node-finder.resources/node-finder-compositing-exposed-parameter.png "Localizador de nós: parâmetros expostos"){zoomable="yes"}
...
![Localizador de nós: pesquisando variável de aviso/erro de Console](node-finder.resources/node-finder-console-identifier.png "Localizador de nós: pesquisando variável de aviso/erro de Console"){zoomable="yes"}
...
![Localizador de nós: pesquisando uma variável corresponde a Obter nós que a utilizam](node-finder.resources/node-finder-exposed-parameter-01.gif "Localizador de nós: pesquisando uma variável corresponde Obter nós que a utilizam"){zoomable="yes"}
...
Cada nó em um gráfico tem um número de identificador exclusivo (UID) que pode ser usado para procurar esse nó.

</td>
<td width="33.33%" style="border: 0;" valign="top">

![Localizador de nós: pesquisar por UID](node-finder.resources/node-finder-compositing-uid-search.png "Localizador de nós: pesquisar por UID"){zoomable="yes"}
...
![Localizador de nós: copiar ação de UID do nó](node-finder.resources/node-finder-compositing-uid-copy.png "Localizador de nós: copiar ação de UID do nó"){zoomable="yes"}
...
![Localizador de nós: pesquisando a UID do nó no Console](node-finder.resources/node-finder-console-uid.png "Localizador de nós: pesquisando a UID do nó no Console"){zoomable="yes"}
...
O botão <b>Opções de pesquisa ![](node-finder.resources/node-finder-search-options.png)</b> permite alternar os modos <b>recursivo</b> e <b>difuso</b> para pesquisar nós.
...
![Localizador de nós: pesquisa recursiva](node-finder.resources/node-finder-recursion-01.png "Localizador de nós: pesquisa recursiva"){zoomable="yes"}
...
+++Exemplo 1
![Localizador de nós: exemplo de pesquisa recursiva 1](node-finder.resources/node-finder-recursion-01.gif "Localizador de nós: exemplo de pesquisa recursiva 1"){zoomable="yes"}
...
+++Exemplo 2
![Localizador de nós: exemplo de pesquisa recursiva 2](node-finder.resources/node-finder-recursion-02.gif "Localizador de nós: exemplo de pesquisa recursiva 2"){zoomable="yes"}
...
![Localizador de nós: Modo difuso](node-finder.resources/node-finder-functions-fuzzy.png "Localizador de nós: Modo difuso"){zoomable="yes"}
