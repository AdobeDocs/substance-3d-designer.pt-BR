...
![Ícone de nó ponto](dot-node.resources/dot-node-01.png "Ícone de nó ponto")
...
![Inserindo um nó Ponto](dot-node.resources/dot-node-02.gif "Inserindo um nó Ponto"){width="512px"}
...
![Ponto: criando do conector](dot-node.resources/dot-node-03.gif "Ponto: criando do conector")
...
![Nó ponto no menu Nó](dot-node.resources/dot-node-04.png "Nó ponto no menu Nó")
...
![Mesclando links](dot-node.resources/dot-node-05.gif "Mesclando links"){width="512px"}
...
![Nó ponto como portal - ícone](dot-node.resources/dot-node-06.png "Nó ponto como portal - ícone")
...
![Nó ponto como portal](dot-node.resources/dot-node-07.gif "Nó ponto como portal")
