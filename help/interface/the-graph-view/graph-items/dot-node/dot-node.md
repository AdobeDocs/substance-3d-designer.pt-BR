...
Um portal é criado automaticamente entre dois nós de ponto - um transmissor e um receptor - quando o nó de ponto do transmissor é nomeado. A nomeação de um nó Ponto é feita com a configuração de um identificador exclusivo em sua propriedade <b>Nome</b>.
