...
![Navegação por porta de visualização](the-graph-view.resources/the-graph-view-01.gif "Navegação por porta de visualização")
...
![Colocando nós](the-graph-view.resources/the-graph-view-02.gif "Colocando nós")
...
![Exibição de gráfico: menu Nó](the-graph-view.resources/the-graph-view-03.png "Exibição de gráfico: menu Nó")
...
![Selecionando nós](the-graph-view.resources/the-graph-view-04.gif "Selecionando nós")
...
![Conectando nós](the-graph-view.resources/the-graph-view-05.gif "Conectando nós")
...
* Eles são exibidos com o emblema ![](the-graph-view.resources/the-graph-view-06.png) <b>Desabilitado</b>*,* um *contorno tracejado* e um link interior *reencaminhamento* em vez de uma miniatura;
...
![Desabilitando nós](the-graph-view.resources/the-graph-view-07.gif "Desabilitando nós"){width="512px"}
...
![](the-graph-view.resources/the-graph-view-08.png) <b>Seleção de foco</b> (F)\
Focaliza a visualização na seleção, ou na cena inteira se a seleção estiver vazia.

![](the-graph-view.resources/the-graph-view-09.png) <b>Redefinir zoom</b> (Z)\
...
![](the-graph-view.resources/the-graph-view-10.png) <b>Exibição de gráfico de exportação\
...
![](the-graph-view.resources/the-graph-view-11.png) <b>Informações do nó\
...
![](the-graph-view.resources/the-graph-view-12.png)<b> Localizador de nós</b> (Ctrl+F)\
...
![](the-graph-view.resources/the-graph-view-13.png) <b>Fluxo de realce\
</b>Realce todos os nós conectados antes ou depois do nó atualmente selecionado. Bom para traçar um caminho complexo de nós.

![](the-graph-view.resources/the-graph-view-14.png) <b>Paleta de nós\
</b>Mostra ou oculta a barra de ferramentas do nó, veja abaixo.

![](the-graph-view.resources/the-graph-view-15.png) <b>Vínculos de retângulo\
...
![](the-graph-view.resources/the-graph-view-16.png) <b>Ferramentas de alinhamento de nós\
...
![](the-graph-view.resources/the-graph-view-17.png) <b>Tamanho do pai\
</b>Alterna a exibição das configurações de controle de Resolução da Página Principal, veja abaixo.

![](the-graph-view.resources/the-graph-view-18.png) <b>Modos de Criação de Link</b> (1, 2, 3)\
...
![](the-graph-view.resources/the-graph-view-19.png) <b>Controle de tempos\
</b>Permite redefinir todos os nós e todos os tempos.

![](the-graph-view.resources/the-graph-view-20.png) <b>Ferramentas\
...
![](the-graph-view.resources/the-graph-view-21.png) <b>Cache de imagem de nó\
</b>Alterna a exibição da alternância de cache de imagem de nó, veja abaixo.

![](the-graph-view.resources/the-graph-view-22.jpg) Remover nós não usados\
...
[![Paleta de nós](the-graph-view.resources/the-graph-view-23.png)](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/atomic-nodes.md)<br>
...
![Paleta de itens de gráfico](the-graph-view.resources/the-graph-view-24.png "Paleta de itens de gráfico")<br>
...
![Paleta FX-Map](the-graph-view.resources/the-graph-view-25.png "paleta FX-Map")<br>
...
![Barra de ferramentas de tamanho pai](the-graph-view.resources/the-graph-view-26.png "Barra de ferramentas de tamanho pai")
...
![Configuração do cache de imagens de nós](the-graph-view.resources/the-graph-view-27.png "Configuração do cache de imagens de nós")
...
![Menu suspenso Remover nós não usados](the-graph-view.resources/the-graph-view-28.jpg "Menu suspenso Remover nós não usados")
