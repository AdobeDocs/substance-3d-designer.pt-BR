...
![Conteúdo personalizado na biblioteca](managing-custom-content-and-filters.resources/library-filters.png "Conteúdo personalizado na biblioteca")
...
<b>![](managing-custom-content-and-filters.resources/library-icon-new-folder.png) Adicionar Pasta:</b> Cria uma pasta expansível na exibição Biblioteca. Você *não pode* criar subpastas.

<b>![](managing-custom-content-and-filters.resources/library-icon-new-filter.png) Adicionar Filtro:</b> Adiciona um novo Filtro dentro da pasta selecionada. Você *não pode* adicionar filtros às pastas padrão existentes.

<b>![](managing-custom-content-and-filters.resources/library-icon-edit.png) Editar Item:</b> Edita a Pasta ou o Filtro selecionado no momento. Você *não pode* editar nenhuma das propriedades das Pastas e Filtros padrão.
...
![Edição de filtro personalizado](managing-custom-content-and-filters.resources/library-filters-edit.png "Edição de filtro personalizado")
