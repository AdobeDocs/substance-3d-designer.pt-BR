...
[![Logotipo da NVIDIA Iray](iray.resources/iray-logo.jpg)](https://www.nvidia.com/en-us/design-visualization/iray/)
...
![Material de parede de castelo medieval renderizado em Iray](iray.resources/iray-overview.png "Material de parede de castelo medieval renderizado em Iray")
...
![Opções de cena](iray.resources/iray-scene-subdivision.gif "Opções de cena")
...
![Menu Materiais](iray.resources/iray-mdl-list.png "Menu Materiais")
...
![Configurações da câmera](iray.resources/camera-dof.png "Configurações da câmera")
...
<table>
  <tr>
    <td>
      <img src="iray.resources/iray-environment-hidden.png" alt="Iray - Ambiente oculto">
      <br><i>Antes</i>
    </td>
    <td>
      <img src="iray.resources/iray-env-visible.png" alt="Iray - Ambiente visível">
      <br><i>Depois</i>
    </td>
  </tr>
</table>
...
![Iray - Ambiente oculto](iray.resources/iray-environment-hidden.png "Iray - Ambiente oculto")

![Iray - Ambiente visível](iray.resources/iray-env-visible.png "Iray - Ambiente visível")
...
<table>
  <tr>
    <td>
      <img src="iray.resources/iray-env-infinite-sphere.png" alt="Iray - somente esfera infinita">
      <br><i>Antes</i>
    </td>
    <td>
      <img src="iray.resources/iray-env-sphere-ground.png" alt="Iray - Esfera infinita com plano do solo">
      <br><i>Depois</i>
    </td>
  </tr>
</table>
...
![Iray - Somente esfera infinita](iray.resources/iray-env-infinite-sphere.png "Iray - Somente esfera infinita")

![Iray - Esfera infinita com plano do solo](iray.resources/iray-env-sphere-ground.png "Iray - Esfera infinita com plano do solo")

+++

+++Girar ambiente
![Girar ambiente](iray.resources/iray-env-rotation.gif "Girar ambiente")
...
![Reflexão do solo](iray.resources/iray-env-ground-options.gif "Reflexão do solo")
...
![Escala do ambiente (esfera)](iray.resources/iray-env-sphere-radius.gif "Escala do ambiente (esfera)")
...
![Escala do ambiente (cubo)](iray.resources/iray-env-box-dimensions.gif "Escala do ambiente (cubo)")
...
![Opções de exibição](iray.resources/iray-display-data.png "Opções de exibição"){width="512px"}
...
<table>
  <tr>
    <td>
      <img src="iray.resources/iray-renderer-none.png" alt="Iray - Renderização base">
      <br><i>Antes</i>
    </td>
    <td>
      <img src="iray.resources/iray-renderer-caustics.png" alt="Iray - Amostrador cáustico ativado">
      <br><i>Depois</i>
    </td>
  </tr>
</table>
...
![Iray - Renderização base](iray.resources/iray-renderer-none.png "Iray - Renderização base")

![Iray - Amostra cáustica habilitada](iray.resources/iray-renderer-caustics.png "Iray - Amostra cáustica habilitada")
...
<table>
  <tr>
    <td>
      <img src="iray.resources/iray-renderer-caustics.png" alt="Iray - filtro Firefly desabilitado">
      <br><i>Antes</i>
    </td>
    <td>
      <img src="iray.resources/iray-renderer-caustics-fireflies.png" alt="Iray - filtro de Firefly habilitado">
      <br><i>Depois</i>
    </td>
  </tr>
</table>
...
![Iray - filtro de Firefly desabilitado](iray.resources/iray-renderer-caustics.png "Iray - filtro de Firefly desabilitado")
...
<table>
  <tr>
    <td>
      <img src="iray.resources/iray-renderer-caustics-fireflies.png" alt="Iray - Pós-desabilitado">
      <br><i>Antes</i>
    </td>
    <td>
      <img src="iray.resources/iray-renderer-caustics-fireflies-denoiser-180.png" alt="Iray - Pós-denoiser habilitado">
      <br><i>Depois</i>
    </td>
  </tr>
</table>
...
![Iray - Pós-denoiser desabilitado](iray.resources/iray-renderer-caustics-fireflies.png "Iray - Pós-denoiser desabilitado")

![Iray - Pós-denoiser habilitado](iray.resources/iray-renderer-caustics-fireflies-denoiser-180.png "Iray - Pós-denoiser habilitado")
...
Você pode selecionar o hardware que deve ser usado pelo Iray para renderização na seção <b>Visualização 3D</b> da janela [Preferências](../../../interface/preferences-window/preferences-window.md), conforme mostrado na imagem à direita.
...
![Preferências de Iray](iray.resources/iray-preferences-hardware.png "Preferências de Iray")
