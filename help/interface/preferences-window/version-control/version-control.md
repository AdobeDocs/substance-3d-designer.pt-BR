...
![Informações do espaço de trabalho P4V](version-control.resources/version-control-01.jpg "Informações do espaço de trabalho P4V"){zoomable="yes"}
...
Guia ![&#39;Controle de versão&#39; nas configurações do projeto](version-control.resources/version-control-02.jpg " Guia&#39;Controle de versão&#39; nas configurações do projeto"){zoomable="yes"}
...
![Configuração P4 no Designer: espaço de trabalho](version-control.resources/version-control-03.jpg "Configuração P4 no Designer: espaço de trabalho"){zoomable="yes"}
...
![Configuração P4 no Designer: ações](version-control.resources/version-control-04.jpg "Configuração P4 no Designer: ações"){zoomable="yes"}
...
![Configuração P4 no Designer: intérprete](version-control.resources/version-control-05.jpg "Configuração P4 no Designer: intérprete"){zoomable="yes"}
...
1. Várias ações estão disponíveis, dependendo do status do arquivo de pacote no espaço de trabalho:
   ...
   * <b>Status da atualização:</b> Atualize o status do arquivo do pacote
   ...
   Caixa de diálogo ![&#39;Enviar&#39;](version-control.resources/version-control-06.jpg "&#39;Enviar&#39;"){zoomable="yes"}

   </td>
   <td style="border: 0;" valign="top">

   ![&#39;Reverter&#39; caixa de diálogo](version-control.resources/version-control-07.jpg "&#39;Reverter&#39; caixa de diálogo"){zoomable="yes"}
...
![Ícone de pacote: atualizado](version-control.resources/version-control-08.png "Ícone de pacote: atualizado")
...
![Ícone de pacote: Check-out](version-control.resources/version-control-09.png "Ícone de pacote: Check-out")
...
![Ícone de pacote: adicionado](version-control.resources/version-control-10.png "Ícone de pacote: adicionado")
...
![Ícone de pacote: não está no depósito](version-control.resources/version-control-11.png "Ícone de pacote: não está no depósito")
