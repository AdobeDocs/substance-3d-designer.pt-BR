...
| <b>Cenas 3D</b> | Por padrão, o Designer usa o **espaço tangente MikkT** no Visualização 3D. MikkT é amplamente utilizado e é o padrão em programas como Unity, Unreal Engine 4, Blender e xNormal.Você pode usar **seu próprio espaço tangente** para o Visualização 3D, que você fornece ao Designer na forma de um *arquivo DLL* de entrada nesta configuração. O rótulo é detectado automaticamente do arquivo DLL, e você pode editar a descrição do plug-in <br><br>*Padrão: mikktspace.dll* Sempre recalcular quadros tangentes <br><br>*Padrão: desmarcado*&#x200B;Ângulo de suavização normal e tangente <br><br>*Padrão: 180.0°* |
| <b>Diversos</b> | Os mapas normais podem ser gerados ou processados usando o formato <b>DirectX</b> ou <b>OpenGL</b>. Essa configuração define o valor desse formato em vários locais, como [propriedades de material](../../../interface/3d-view/material-properties/material-properties.md) nos parâmetros de nó de filtro [Visualização 3D](../../../interface/3d-view/3d-view.md) e [Normal](../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/normal/normal.md).<br><br>*Padrão: DirectX*<br><br> Em relação ao nó de filtro [Normal](../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/normal/normal.md), você pode definir o valor padrão do parâmetro <b>Conteúdo do Canal Alfa</b>. Você pode optar por forçar o alfa para 1 em todos os casos ou preenchê-lo com informações de sua entrada.<br><br>*Padrão: forçar Alpha para 1* |
...
Se um documento do [Photoshop](https://www.adobe.com/products/photoshop.html) (arquivo\*.PSD) incluído na biblioteca tiver <b>várias camadas</b>, uma opção permitirá exibir o conteúdo de* cada camada como uma entrada de imagem separada* na biblioteca.
