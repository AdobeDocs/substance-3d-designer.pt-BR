...
breadcrumb-title: ''
description: Use a ferramenta Sampler de cores no Visualização 2D para obter amostras de cores do textura para uma correspondência precisa de cores.
...
A ferramenta Sampler de Cores permite <b>rastrear o valor de um pixel específico</b> em [Visualização 2D](../../../interface/2d-view/2d-view.md) conforme você ajusta os parâmetros ou alterna os nós.

Ele coloca uma fixar na viewport e faz a amostragem da cor e da posição do pixel nesse local.

## Usar a ferramenta

Siga estas etapas para acessar e usar a ferramenta:

1. Clique no botão ![](../../../assets/color-sampler-information-button.png) <b>Informações</b> na barra de ferramentas do Visualização 2D para abrir o Dock de informações e a barra de ferramentas
1. Clique no botão ![](../../../assets/color-sampler-tool-icon.png) <b>Ferramenta Color Sampler</b> na barra de ferramentas Informações
1. No visor, clique no pixel específico em que você deseja obter uma amostra para colocar um ![](../../../assets/color-sampler-pin-icon.png) <b>fixar</b>
1. Examine os valores de amostra na seção dedicada do Dock de informações
1. Quando terminar de usar a ferramenta, clique no botão ![](../../../assets/color-sampler-remove-pin.png) <b>Excluir</b> para remover a fixar do visor.\
   Você também pode remover o fixar clicando com o botão direito do mouse nele e selecionando a ação “Excluir” no menu contextual.
...
Você pode copiar os valores amostrados clicando em RMB no fixar e selecionando a ação “Copiar valores RGBA” no menu contextual.
...
* <b>Baixa precisão de HDR (16 bits)</b>: um valor de ponto flutuante codificado usando 16 bits.
* <b>Alta precisão de HDR (32 bits)</b>: um valor de ponto flutuante codificado usando 32 bits. Esta é a maior precisão disponível no Designer.
