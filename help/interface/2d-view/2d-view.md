...
![Exibição 2D](2d-view.resources/2d-view-main.png "Exibição 2D")
...
*Vários* painéis de exibição 2D podem estar ativos a qualquer momento, e cada um pode exibir imagens ou valores diferentes. Você pode controlar quando um novo painel deve ser usado usando o recurso ![](2d-view.resources/2d-view-icon-pin.png) <b>Pin</b> do painel de interface do usuário.
...
![Exibir cópia para a área de transferência](2d-view.resources/2d-view-copy-clipboard.gif "Exibir cópia para a área de transferência"){width="360px"}
...
![Saídas do gráfico do comutador de exibição 2D](2d-view.resources/2d-view-switch-graph-outputs.gif "Saídas do gráfico do comutador de exibição 2D"){width="360px"}
...
+++Sobreposição UV
![Sobreposição UV de exibição 2D](2d-view.resources/2d-view-uv.png "Sobreposição UV de exibição 2D"){width="357px"}
...
![Informações da imagem de exibição 2D](2d-view.resources/2d-view-information.png "Informações da imagem de exibição 2D"){width="360px"}
...
+++Histograma
![Histograma de exibição 2D](2d-view.resources/2d-view-histogram.png "Histograma de exibição 2D"){width="360px"}
...
![Canais de cores de exibição 2D](2d-view.resources/2d-view-color-channel.png "Canais de cores de exibição 2D"){width="360px"}
...
![Alternar transparência de exibição 2D](2d-view.resources/2d-view-transparency.png "Alternar transparência de exibição 2D"){width="360px"}
...
![Espaço de cores de exibição 2D](2d-view.resources/2d-view-viewport-color-space.png "Espaço de cores de exibição 2D"){width="360px"}
...
![Ferramentas de pintura de bitmap de exibição 2D](2d-view.resources/2dview-paintingtools-main.png "Ferramentas de pintura de bitmap de exibição 2D")
...
![Editor de gráficos vetoriais de exibição 2D](2d-view.resources/2dview-vectorediting-main.png "Editor de gráficos vetoriais de exibição 2D")
...
![Gerenciamento de cores de exibição 2D](2d-view.resources/2d-view-color-management-ocio.png "Gerenciamento de cores de exibição 2D"){width="360px"}
...
* <b>ACE de Adobe:</b> você pode ![](2d-view.resources/2d-view-icon-color-space.png) *habilitar* o gerenciamento de cores e definir o espaço de cores mais apropriado para o *monitor atual*, conforme detectado pelo mecanismo ACE de Adobe, ou ![](2d-view.resources/2d-view-icon-color-space-linear.png) *desabilitar* o gerenciamento de cores e exibir a imagem usando os valores de cores raw;
* <b>OCIO:</b> você pode ![](2d-view.resources/2d-view-icon-color-space.png) *habilitar* o gerenciamento de cores e definir o mais apropriado para o *monitor atual* conforme detectado pelo mecanismo OCIO. Use a caixa de combinação e selecione qualquer um dos *espaços de cores de exibição* disponíveis no [arquivo de configuração OCIO](../../color-management/color-management.md) atualmente em uso ou ![](2d-view.resources/2d-view-icon-color-space-linear.png) *desabilitar* o gerenciamento de cores e exibir a imagem usando os valores de cores raw.
