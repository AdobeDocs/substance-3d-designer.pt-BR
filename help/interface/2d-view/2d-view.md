...
breadcrumb-title: ''
description: Use o Visualização 2D no Substance 3D Designer para visualizar e inspecionar as saídas de textura dos gráficos de materiais.
...
Esta página descreve a interface do usuário e os recursos do painel **Visualização 2D** no Substance 3D Designer.

![Visualização 2D](2d-view.resources/2d-view-main.png "Visualização 2D")

## Visão geral

O [Visualização 2D](https://substance3d.adobe.com/) é um dos painéis principais da interface de usuário do Designer. Seus principais objetivos são os seguintes:
...
Quando uma imagem exibida ou um valor é modificado, o Visualização 2D *é atualizado automaticamente* para permanecer em sincronia com o estado atual dos dados.\
*Vários* painéis de Visualização 2D podem estar ativos a qualquer momento, e cada um pode exibir imagens ou valores diferentes. Você pode controlar quando um novo painel deve ser usado usando o recurso ![](2d-view.resources/2d-view-icon-pin.png) <b>Fixar</b> do painel de interface do usuário.
...
A maneira mais direta de exibir qualquer imagem no Visualização 2D é clicar duas vezes no *LMB*...
...
Na Exibição de Gráfico, você pode enviar uma imagem para o Visualização 2D usando a opção de menu contextual <b>Exibir saída em Visualização 2D</b>, que é acessada clicando em *RMB*...
...
* <b>Ajustar para ajustar o visor:</b> botão F / &#39;Ajustar para visualização&#39; ![](2d-view.resources/2d-view-icon-fit-to-view.png)
* <b>Ajustar para escala 1:1:</b> Z / botão &#39;Ajustar à escala&#39; ![](2d-view.resources/2d-view-icon-fit-to-scale.png)

</td>
<td style="border: 0;" valign="top">

![Navegação no visor 2D](2d-view.resources/2d-view-viewport-navigation.gif "Navegação no visor 2D")
...
* Exibição lado a lado: *repete a imagem* no visor usando um padrão lado a lado. Isso é útil para verificar como um padrão ou textura se repetirá. É habilitada com o uso da **Barra de espaços** ou do botão ![](2d-view.resources/2d-view-icon-tiling.png) **Exibição lado a lado**
* Exibição de tamanho físico: exibe a imagem com uma *proporção* correspondente à propriedade [Tamanho físico](../../compositing-graphs/graph-parameters/graph-parameters.md) do gráfico. Ela é habilitada usando o botão ![](2d-view.resources/2d-view-icon-physical-size.png) **proporção de Tamanho físico**
* Manter tamanho da exibição: esta opção *bloqueia a escala de exibição* para que ela permaneça consistente em todas as imagens diferentes. Está *habilitado por padrão* e pode ser desabilitado com o botão ![](2d-view.resources/2d-view-icon-lock-scale.png) **Manter tamanho de exibição**
...
+++Imagem do fundo
![Imagem de plano de fundo de exibição 2D](2d-view.resources/2d-view-background.png "Imagem de plano de fundo de exibição 2D"){width="360px"}



Você pode *sobrepor uma imagem diferente* sobre a imagem atualmente exibida. Pressione o botão ![](2d-view.resources/2d-view-icon-background.png) <b>Imagem de Fundo</b> e você será solicitado a selecionar um arquivo de imagem para usar como sobreposição.
...
<b>![](2d-view.resources/2d-view-icon-background-close.png) Fechar:</b> *feche* a barra de ferramentas de controles de sobreposição e *desabilite* a sobreposição da imagem de fundo.

<b>![](2d-view.resources/2d-view-icon-background-loadpng.png) Carregar imagem:</b> selecione *outro arquivo de imagem* para usar como sobreposição.

<b>![](2d-view.resources/2d-view-icon-background-0.png) Imagem de origem:</b> define a sobreposição da imagem como *0%* de opacidade.

<b>![](2d-view.resources/2d-view-icon-background-100.png) Imagem de fundo:</b> define a sobreposição da imagem como *100%* de opacidade.

<b>![](2d-view.resources/2d-view-icon-background-50.png) Redefinir:</b> define a imagem de sobreposição para *50%* de opacidade.
...
+++Exportar imagem
![Imagem de exportação de exibição 2D](2d-view.resources/2d-view-export-bitmap.png "Imagem de exportação de exibição 2D"){width="360px"}



A imagem atualmente exibida pode ser *exportada para um arquivo de imagem*. Pressione o botão ![](2d-view.resources/2d-view-icon-export.png) <b>Salvar Imagem...</b> e você será solicitado a selecionar um *local*, *nome* e *formato de arquivo* para o arquivo exportado.
...
![Copiar para a área de transferência](2d-view.resources/2d-view-copy-clipboard.gif "Copiar para a área de transferência"){width="360px"} do Visualização 2D



A imagem atualmente exibida pode ser *copiada para a área de transferência*. Pressione o botão ![](2d-view.resources/2d-view-icon-copy.png) <b>Copiar Imagem para a Área de Transferência</b> e a imagem estará pronta para ser colada em qualquer software de terceiros, como o Adobe Photoshop.
...
![saídas de gráfico do Visualização 2D switch](2d-view.resources/2d-view-switch-graph-outputs.gif "saídas de gráfico do Visualização 2D"){width="360px"}



Se a imagem atualmente exibida for uma *saída de gráfico*, você poderá *alternar rapidamente para qualquer* outra saída de gráfico usando o botão ![](2d-view.resources/2d-view-icon-view-outputs.png) <b>Selecionar saída</b>.
...
+++Sobreposição UV
![Sobreposição de UV de Visualização 2D](2d-view.resources/2d-view-uv.png "Sobreposição de UV de Visualização 2D"){width="357px"}



Se a opção <b>Exibir UVs no Visualização 2D</b> estiver habilitada no menu <b>Cena</b> do encaixe [Visualização 3D](../../interface/3d-view/3d-view.md), o recurso de sobreposição UV estará disponível no Visualização 2D.

Você pode habilitá-lo usando o botão <b>UV</b>. ![](2d-view.resources/2d-view-icon-uv.png)

Isso exibe os UVs da malha [atualmente selecionados no Visualização 3D](../../interface/3d-view/3d-view.md) como um wireframe colorido.
...
![informações da imagem](2d-view.resources/2d-view-information.png "informações da Visualização 2D"){width="360px"}



Você pode exibir os *valores exatos de pixel* *e as coordenadas* em uma imagem com o painel <b>Informações</b>, que é habilitado usando o botão ![](2d-view.resources/2d-view-icon-information.png) <b>Informações da Imagem</b>. Isso é muito útil ao inspecionar imagens HDR, por exemplo, ou garantir que a depuração entre pixels siga a progressão pretendida.
...
+++Histograma
![Visualização 2D](2d-view.resources/2d-view-histogram.png "Visualização 2D"){width="360px"}



Você pode exibir o *histograma* da imagem com o painel <b>Histograma</b>, que é habilitado usando o botão ![](2d-view.resources/2d-view-icon-histogram.png) <b>Exibir histograma</b>.
...
![canais de Visualização 2D](2d-view.resources/2d-view-color-channel.png "canais de Visualização 2D"){width="360px"}

### Canais de cores

Você pode exibir um único canal da imagem usando o botão ![](2d-view.resources/2d-view-icon-channels.png) <b>Canais de cores</b>. Isso abre uma caixa de combinação que permite selecionar quais canais <b>Vermelhos</b>, <b>Verdes</b>, <b>Azuis</b> e <b>Alpha</b> devem ser exibidos. O aspecto normal da imagem com todos os canais é restaurado selecionando a opção <b>RGB</b>.
...
![Alternar transparência do Visualização 2D](2d-view.resources/2d-view-transparency.png "Alternar transparência do Visualização 2D"){width="360px"}

### Alternar transparência

A exibição de transparência pode ser ativada e desativada usando o botão ![](2d-view.resources/2d-view-icon-transparency-off.png)/![](2d-view.resources/2d-view-icon-transparency-on.png) <b>Mostrar tabuleiro de xadrez</b>. Quando habilitada, a transparência é exibida usando um padrão quadriculado.

Há duas maneiras principais de interpretar a transparência, que podem ser selecionadas usando o botão ![](2d-view.resources/2d-view-icon-transparency-straight.png)/![](2d-view.resources/3d-view-icon-transparency-premultiplied.png) <b>Modo de transparência</b>:

<b>![](2d-view.resources/2d-view-icon-transparency-straight.png) Reta:</b> as informações de transparência são armazenadas somente no canal alfa e não afetam nenhum outro aspecto da imagem

<b>![](2d-view.resources/3d-view-icon-transparency-premultiplied.png) Pré-multiplicado:</b> as informações de transparência são armazenadas no canal alfa e também afetam os canais RGB, pois são multiplicados efetivamente em relação ao canal alfa
...
![espaço de cores do Visualização 2D](2d-view.resources/2d-view-viewport-color-space.png "espaço de cores"){width="360px"}
...
![ferramentas de pintura de Visualização 2D](2d-view.resources/2dview-paintingtools-main.png "ferramentas de pintura de Visualização 2D")
...
![editor de gráficos vetoriais do Visualização 2D](2d-view.resources/2dview-vectorediting-main.png "editor de gráficos vetoriais do Visualização 2D")
...
![gerenciamento de cores do Visualização 2D](2d-view.resources/2d-view-color-management-ocio.png "gerenciamento de cores do Visualização 2D"){width="360px"}
...
* <b>Legado:</b> você pode exibir a imagem nos espaços de cores sRGB ![](2d-view.resources/2d-view-icon-color-space.png) ou sRGB Linear ![](2d-view.resources/2d-view-icon-color-space-linear.png);
* <b>Adobe ACE:</b> você pode ![](2d-view.resources/2d-view-icon-color-space.png) *habilitar* o gerenciamento de cores e definir o espaço de cores mais apropriado para o *monitor atual*, conforme detectado pelo mecanismo de ACE de Adobe, ou ![](2d-view.resources/2d-view-icon-color-space-linear.png) *desabilitar* o gerenciamento de cores e exibir a imagem usando os valores de cores raw;
* <b>OCIO:</b> você pode ![](2d-view.resources/2d-view-icon-color-space.png) *habilitar* o gerenciamento de cores e definir o mais apropriado para o *monitor atual* conforme detectado pelo mecanismo OCIO, usar a caixa de combinação e selecionar qualquer um dos *espaços de cores de exibição* disponíveis no [arquivo de configuração OCIO](../../color-management/color-management.md) atualmente usado, ou ![](2d-view.resources/2d-view-icon-color-space-linear.png) *desabilitar* o gerenciamento de cores e exibir a imagem usando os valores de cores Raw.
