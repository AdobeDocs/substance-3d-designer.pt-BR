...
![Exibição 2D](2d-view.resources/2d-view-01.png "Exibição 2D")
...
*Vários* painéis de exibição 2D podem estar ativos a qualquer momento, e cada um pode exibir imagens ou valores diferentes. Você pode controlar quando um novo painel deve ser usado usando o recurso ![](2d-view.resources/2d-view-02.png) <b>Pin</b> do painel de interface do usuário.
...
* <b>Ajustar para ajustar o visor:</b> botão F / &#39;Ajustar para visualização&#39; ![](2d-view.resources/2d-view-04.png)
* <b>Ajustar para escala 1:1:</b> Z / botão &#39;Ajustar à escala&#39; ![](2d-view.resources/2d-view-05.png)

</td>
<td style="border: 0;" valign="top">

![Navegação no visor 2D](2d-view.resources/2d-view-06.gif "Navegação no visor 2D")
...
* Exibição lado a lado: *repete a imagem* no visor usando um padrão lado a lado. Isso é útil para verificar como um padrão ou textura se repetirá. É habilitada com o uso da **Barra de espaços** ou do botão ![](2d-view.resources/2d-view-07.png) **Exibição lado a lado**
* Exibição de tamanho físico: exibe a imagem com uma *proporção* correspondente à propriedade [Tamanho físico](../../compositing-graphs/graph-parameters/graph-parameters.md) do gráfico. Ela é habilitada usando o botão ![](2d-view.resources/2d-view-08.png) **proporção de Tamanho físico**
* Manter tamanho da exibição: esta opção *bloqueia a escala de exibição* para que ela permaneça consistente em todas as imagens diferentes. Está *habilitado por padrão* e pode ser desabilitado com o botão ![](2d-view.resources/2d-view-09.png) **Manter tamanho de exibição**
...
+++Imagem do fundo
![Imagem de plano de fundo de exibição 2D](2d-view.resources/2d-view-10.png "Imagem de plano de fundo de exibição 2D"){width="360px"}



Você pode *sobrepor uma imagem diferente* sobre a imagem atualmente exibida. Pressione o botão ![](2d-view.resources/2d-view-11.png) <b>Imagem de Fundo</b> e você será solicitado a selecionar um arquivo de imagem para usar como sobreposição.
...
<b>![](2d-view.resources/2d-view-12.png) Fechar:</b> *feche* a barra de ferramentas de controles de sobreposição e *desabilite* a sobreposição da imagem de fundo.

<b>![](2d-view.resources/2d-view-13.png) Carregar imagem:</b> selecione *outro arquivo de imagem* para usar como sobreposição.

<b>![](2d-view.resources/2d-view-14.png) Imagem de origem:</b> define a sobreposição da imagem como *0%* de opacidade.

<b>![](2d-view.resources/2d-view-15.png) Imagem de fundo:</b> define a sobreposição da imagem como *100%* de opacidade.

<b>![](2d-view.resources/2d-view-16.png) Redefinir:</b> define a imagem de sobreposição para *50%* de opacidade.
...
+++Exportar imagem
![Imagem de exportação de exibição 2D](2d-view.resources/2d-view-17.png "Imagem de exportação de exibição 2D"){width="360px"}



A imagem atualmente exibida pode ser *exportada para um arquivo de imagem*. Pressione o botão ![](2d-view.resources/2d-view-18.png) <b>Salvar Imagem...</b> e você será solicitado a selecionar um *local*, *nome* e *formato de arquivo* para o arquivo exportado.
...
![Exibir cópia para a área de transferência](2d-view.resources/2d-view-19.gif "Exibir cópia para a área de transferência"){width="360px"}



A imagem atualmente exibida pode ser *copiada para a área de transferência*. Pressione o botão ![](2d-view.resources/2d-view-20.png) <b>Copiar Imagem para a Área de Transferência</b> e a imagem estará pronta para ser colada em qualquer software de terceiros, como o Adobe Photoshop.
...
![Saídas do gráfico do comutador de exibição 2D](2d-view.resources/2d-view-21.gif "Saídas do gráfico do comutador de exibição 2D"){width="360px"}



Se a imagem atualmente exibida for uma *saída de gráfico*, você poderá *alternar rapidamente para qualquer* outra saída de gráfico usando o botão ![](2d-view.resources/2d-view-22.png) <b>Selecionar saída</b>.
...
+++Sobreposição UV
![Sobreposição UV de exibição 2D](2d-view.resources/2d-view-23.png "Sobreposição UV de exibição 2D"){width="357px"}
...
Você pode habilitá-lo usando o botão <b>UV</b>. ![](2d-view.resources/2d-view-24.png)
...
![Informações da imagem de exibição 2D](2d-view.resources/2d-view-25.png "Informações da imagem de exibição 2D"){width="360px"}



Você pode exibir os *valores exatos de pixel* *e as coordenadas* em uma imagem com o painel <b>Informações</b>, que é habilitado usando o botão ![](2d-view.resources/2d-view-26.png) <b>Informações da Imagem</b>. Isso é muito útil ao inspecionar imagens HDR, por exemplo, ou garantir que a depuração entre pixels siga a progressão pretendida.
...
+++Histograma
![Histograma de exibição 2D](2d-view.resources/2d-view-27.png "Histograma de exibição 2D"){width="360px"}



Você pode exibir o *histograma* da imagem com o painel <b>Histograma</b>, que é habilitado usando o botão ![](2d-view.resources/2d-view-28.png) <b>Exibir histograma</b>.
...
![Alternar transparência de exibição 2D](2d-view.resources/2d-view-31.png "Alternar transparência de exibição 2D"){width="360px"}

### Alternar transparência

A exibição de transparência pode ser ativada e desativada usando o botão ![](2d-view.resources/2d-view-32.png)/![](2d-view.resources/2d-view-33.png) <b>Mostrar tabuleiro de xadrez</b>. Quando habilitada, a transparência é exibida usando um padrão quadriculado.

Há duas maneiras principais de interpretar a transparência, que podem ser selecionadas usando o botão ![](2d-view.resources/2d-view-34.png)/![](2d-view.resources/2d-view-35.png) <b>Modo de transparência</b>:

<b>![](2d-view.resources/2d-view-34.png) Reta:</b> as informações de transparência são armazenadas somente no canal alfa e não afetam nenhum outro aspecto da imagem

<b>![](2d-view.resources/2d-view-35.png) Pré-multiplicado:</b> as informações de transparência são armazenadas no canal alfa e também afetam os canais RGB, pois são multiplicados efetivamente em relação ao canal alfa
...
![Espaço de cores de exibição 2D](2d-view.resources/2d-view-36.png "Espaço de cores de exibição 2D"){width="360px"}
...
![Ferramentas de pintura de bitmap de exibição 2D](2d-view.resources/2d-view-39.png "Ferramentas de pintura de bitmap de exibição 2D")
...
![Editor de gráficos vetoriais de exibição 2D](2d-view.resources/2d-view-40.png "Editor de gráficos vetoriais de exibição 2D")
...
![Gerenciamento de cores de exibição 2D](2d-view.resources/2d-view-41.png "Gerenciamento de cores de exibição 2D"){width="360px"}
...
* <b>Legado:</b> você pode exibir a imagem nos espaços de cores sRGB ![](2d-view.resources/2d-view-37.png) ou sRGB Linear ![](2d-view.resources/2d-view-38.png);
* <b>ACE de Adobe:</b> você pode ![](2d-view.resources/2d-view-37.png) *habilitar* o gerenciamento de cores e definir o espaço de cores mais apropriado para o *monitor atual*, conforme detectado pelo mecanismo ACE de Adobe, ou ![](2d-view.resources/2d-view-38.png) *desabilitar* o gerenciamento de cores e exibir a imagem usando os valores de cores raw;
* <b>OCIO:</b> você pode ![](2d-view.resources/2d-view-37.png) *habilitar* o gerenciamento de cores e definir o mais apropriado para o *monitor atual* conforme detectado pelo mecanismo OCIO. Use a caixa de combinação e selecione qualquer um dos *espaços de cores de exibição* disponíveis no [arquivo de configuração OCIO](../../color-management/color-management.md) atualmente em uso ou ![](2d-view.resources/2d-view-38.png) *desabilitar* o gerenciamento de cores e exibir a imagem usando os valores de cores raw.
